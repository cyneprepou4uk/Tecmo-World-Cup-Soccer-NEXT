...
.export sub_0x0043BA
.export sub_0x00448D
.export sub_0x004531_team_palette
.export sub_0x0045A6
.export sub_0x00464C
...
C - - - - - 0x004065 01:8055: 10 02     BPL bra_8059_someone_has_ball
C - - - - - 0x004067 01:8057: A9 16     LDA #con_ball_index
bra_8059_someone_has_ball:
C - - - - - 0x004069 01:8059: 20 57 C0  JSR sub_0x00CBF3_get_base_player_address
C - - - - - 0x00406C 01:805C: 38        SEC
C - - - - - 0x00406D 01:805D: A0 05     LDY #con_plr_pos_X_lo
C - - - - - 0x00406F 01:805F: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x004076 01:8066: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x0040AC 01:809C: D0 EB     BNE bra_8089_loop
bra_809E:
...
C - - - - - 0x00414A 01:813A: AD 7D 03  LDA ram_buffer_bg_flag
C - - - - - 0x00414D 01:813D: D0 F6     BNE bra_8135_loop
C - - - - - 0x00414F 01:813F: A9 01     LDA #$01
C - - - - - 0x004151 01:8141: 8D 7D 03  STA ram_buffer_bg_flag
...
C - - - - - 0x004172 01:8162: 8D 0D 03  STA ram_buffer_bg_hi
C - - - - - 0x004175 01:8165: 8D 18 03  STA ram_buffer_bg_data + 8
...
C - - - - - 0x004181 01:8171: 8D 0E 03  STA ram_buffer_bg_lo
C - - - - - 0x004184 01:8174: 8D 19 03  STA ram_buffer_bg_data + 9
C - - - - - 0x004187 01:8177: A9 23     LDA #$23
C - - - - - 0x004189 01:8179: 8D 0F 03  STA ram_buffer_bg_cnt
C - - - - - 0x00418C 01:817C: A9 27     LDA #$27
C - - - - - 0x00418E 01:817E: 8D 1A 03  STA ram_buffer_bg_data + 10
C - - - - - 0x004191 01:8181: A2 00     LDX #$00
C - - - - - 0x004193 01:8183: 68        PLA
bra_8184_loop:
C - - - - - 0x004194 01:8184: 9D 10 03  STA ram_buffer_bg_data,X
C - - - - - 0x004197 01:8187: 9D 1B 03  STA ram_buffer_bg_data + 11,X
C - - - - - 0x00419A 01:818A: E8        INX
C - - - - - 0x00419B 01:818B: E0 08     CPX #$08
C - - - - - 0x00419D 01:818D: D0 F5     BNE bra_8184_loop
C - - - - - 0x00419F 01:818F: A9 00     LDA #$00
C - - - - - 0x0041A1 01:8191: 8D 23 03  STA ram_buffer_bg_data + 19
C - - - - - 0x0041A4 01:8194: A9 80     LDA #$80
C - - - - - 0x0041A6 01:8196: 8D 7D 03  STA ram_buffer_bg_flag
...
C - - - - - 0x0041B3 01:81A3: AD 7D 03  LDA ram_buffer_bg_flag
C - - - - - 0x0041B6 01:81A6: D0 F6     BNE bra_819E_loop
C - - - - - 0x0041B8 01:81A8: A9 01     LDA #$01
C - - - - - 0x0041BA 01:81AA: 8D 7D 03  STA ram_buffer_bg_flag
...
C - - - - - 0x0041DB 01:81CB: 8D 7D 03  STA ram_buffer_bg_flag
C - - - - - 0x0041DE 01:81CE: 4C 9E 81  JMP loc_819E_loop
bra_81D1:
C - - - - - 0x0041E1 01:81D1: A9 80     LDA #$80
C - - - - - 0x0041E3 01:81D3: 8D 7D 03  STA ram_buffer_bg_flag
...
C - - - - - 0x0041EE 01:81DE: A9 16     LDA #con_ball_index
bra_81E0_someone_has_ball:
C - - - - - 0x0041F0 01:81E0: 20 57 C0  JSR sub_0x00CBF3_get_base_player_address
C - - - - - 0x0041F3 01:81E3: A0 0B     LDY #con_plr_pos_Y_lo
C - - - - - 0x0041F5 01:81E5: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x0041FD 01:81ED: B1 61     LDA (ram_plr_data),Y
...
tbl_82AB:
- D 0 - - - 0x0042BB 01:82AB: E0 00     .word $00E0
- D 0 - - - 0x0042BD 01:82AD: 40 02     .word $0240
- D 0 - - - 0x0042BF 01:82AF: 00 30     .word $3000
...
C - - - - - 0x0042E4 01:82D4: 9D 0D 03  STA ram_buffer_bg_hi,X
C - - - - - 0x0042E7 01:82D7: 9D 18 03  STA ram_buffer_bg_data + 8,X
...
C - - - - - 0x0042F6 01:82E6: 9D 0E 03  STA ram_buffer_bg_lo,X
C - - - - - 0x0042F9 01:82E9: B9 32 83  LDA tbl_8332,Y
C - - - - - 0x0042FC 01:82EC: 6D C6 03  ADC ram_03C6
C - - - - - 0x0042FF 01:82EF: 9D 0F 03  STA ram_buffer_bg_cnt,X
C - - - - - 0x004302 01:82F2: 48        PHA
C - - - - - 0x004303 01:82F3: BD 0E 03  LDA ram_buffer_bg_lo,X
C - - - - - 0x004306 01:82F6: 18        CLC
C - - - - - 0x004307 01:82F7: 69 20     ADC #$20
C - - - - - 0x004309 01:82F9: 9D 19 03  STA ram_buffer_bg_data + 9,X
C - - - - - 0x00430C 01:82FC: 68        PLA
C - - - - - 0x00430D 01:82FD: 69 00     ADC #$00
C - - - - - 0x00430F 01:82FF: 9D 1A 03  STA ram_buffer_bg_data + 10,X
...
C - - - - - 0x00431C 01:830C: 9D 0D 03  STA ram_buffer_bg_hi,X
...
C - - - - - 0x004332 01:8322: 9D 10 03  STA ram_buffer_bg_data,X
...
C - - - - - 0x00435F 01:834F: 8D 89 03  STA ram_buffer_pal_data + 6
C - - - - - 0x004362 01:8352: 8D 8D 03  STA ram_buffer_pal_data + 10
...
C - - - - - 0x004391 01:8381: D0 F7     BNE bra_837A_loop
bra_8383:
...
C - - - - - 0x0044AC 01:849C: 29 20     AND #con_gm_out_of_play
...
C - - - - - 0x0044C1 01:84B1: D0 F7     BNE bra_84AA_loop
bra_84B3:
...
C - - - - - 0x0044F7 01:84E7: A9 0A     LDA #con_sound_time_low
C - - - - - 0x0044F9 01:84E9: 20 7E C0  JSR sub_0x00C920_prepare_sound
bra_84EC_RTS:
...
C - - - - - 0x00452D 01:851D: 20 7B C0  JSR sub_0x00F9B5
C - - - - - 0x004530 01:8520: 60        RTS



sub_0x004531_team_palette:
C D 0 - - - 0x004531 01:8521: A2 00     LDX #$00
C - - - - - 0x004533 01:8523: AD A9 03  LDA ram_team_id
C - - - - - 0x004536 01:8526: 20 3C 85  JSR sub_853C_write_palette_to_buffer
C - - - - - 0x004539 01:8529: A2 08     LDX #$08
C - - - - - 0x00453B 01:852B: AD AA 03  LDA ram_team_id + 1
C - - - - - 0x00453E 01:852E: 20 3C 85  JSR sub_853C_write_palette_to_buffer
C - - - - - 0x004541 01:8531: A9 0F     LDA #$0F
C - - - - - 0x004543 01:8533: 8D 99 03  STA ram_buffer_pal_data + 22
C - - - - - 0x004546 01:8536: A9 30     LDA #$30
C - - - - - 0x004548 01:8538: 8D 9A 03  STA ram_buffer_pal_data + 23
C - - - - - 0x00454B 01:853B: 60        RTS



sub_853C_write_palette_to_buffer:
C - - - - - 0x00454C 01:853C: 0A        ASL
C - - - - - 0x00454D 01:853D: 0A        ASL
C - - - - - 0x00454E 01:853E: A8        TAY
C - - - - - 0x00454F 01:853F: B9 59 85  LDA tbl_8556 + 3,Y
C - - - - - 0x004552 01:8542: 9D 98 03  STA ram_buffer_pal_data + 21,X
C - - - - - 0x004555 01:8545: A9 02     LDA #$02
C - - - - - 0x004557 01:8547: 85 2B     STA ram_002B
bra_8549_loop:
C - - - - - 0x004559 01:8549: B9 56 85  LDA tbl_8556,Y
C - - - - - 0x00455C 01:854C: 9D 94 03  STA ram_buffer_pal_data + 17,X
C - - - - - 0x00455F 01:854F: E8        INX
C - - - - - 0x004560 01:8550: C8        INY
C - - - - - 0x004561 01:8551: C6 2B     DEC ram_002B
C - - - - - 0x004563 01:8553: 10 F4     BPL bra_8549_loop
C - - - - - 0x004565 01:8555: 60        RTS



tbl_8556:
- D 0 - - - 0x004566 01:8556: 37        .byte $37, $11, $16,    $0F   ; 
- D 0 - - - 0x00456A 01:855A: 0A        .byte $0A, $30, $35,    $37   ; 
- D 0 - - - 0x00456E 01:855E: 11        .byte $11, $30, $35,    $37   ; 
- D 0 - - - 0x004572 01:8562: 26        .byte $26, $30, $35,    $17   ; 
- D 0 - - - 0x004576 01:8566: 31        .byte $31, $0F, $36,    $0F   ; 
- D 0 - - - 0x00457A 01:856A: 16        .byte $16, $30, $35,    $37   ; 
- D 0 - - - 0x00457E 01:856E: 2C        .byte $2C, $30, $35,    $17   ; 
- D 0 - - - 0x004582 01:8572: 14        .byte $14, $30, $35,    $26   ; 
- D 0 - - - 0x004586 01:8576: 30        .byte $30, $31, $35,    $37   ; 
- D 0 - - - 0x00458A 01:857A: 25        .byte $25, $11, $35,    $37   ; 
- D 0 - - - 0x00458E 01:857E: 28        .byte $28, $30, $26,    $37   ; 
- D 0 - - - 0x004592 01:8582: 01        .byte $01, $21, $35,    $16   ; 
- D 0 - - - 0x004596 01:8586: 21        .byte $21, $30, $35,    $17   ; 
- D 0 - - - 0x00459A 01:858A: 34        .byte $34, $30, $35,    $17   ; 
- D 0 - - - 0x00459E 01:858E: 25        .byte $25, $16, $36,    $0F   ; 
- D 0 - - - 0x0045A2 01:8592: 30        .byte $30, $16, $36,    $0F   ; 
...
C - - - - - 0x0045A9 01:8599: 30 08     BMI bra_85A3_loop
...
C - - - - - 0x0045B8 01:85A8: AD 7D 03  LDA ram_buffer_bg_flag
C - - - - - 0x0045BB 01:85AB: D0 F6     BNE bra_85A3_loop
C - - - - - 0x0045BD 01:85AD: A9 01     LDA #$01
C - - - - - 0x0045BF 01:85AF: 8D 7D 03  STA ram_buffer_bg_flag
...
C - - - - - 0x0045CA 01:85BA: BD 46 A4  LDA tbl_A446_goal_net_hit,X
C - - - - - 0x0045CD 01:85BD: 85 2A     STA ram_002A
C - - - - - 0x0045CF 01:85BF: BD 47 A4  LDA tbl_A446_goal_net_hit + 1,X
...
C - - - - - 0x0045F8 01:85E8: AD 7D 03  LDA ram_buffer_bg_flag
C - - - - - 0x0045FB 01:85EB: D0 F6     BNE bra_85E3_loop
C - - - - - 0x0045FD 01:85ED: A9 01     LDA #$01
C - - - - - 0x0045FF 01:85EF: 8D 7D 03  STA ram_buffer_bg_flag
C - - - - - 0x004602 01:85F2: AE CE 03  LDX ram_03CE
C - - - - - 0x004605 01:85F5: BD CE 03  LDA ram_03CE,X
C - - - - - 0x004608 01:85F8: A2 8F     LDX #< tbl_A58F_goal_team_2_gfx
C - - - - - 0x00460A 01:85FA: A0 A5     LDY #> tbl_A58F_goal_team_2_gfx
C - - - - - 0x00460C 01:85FC: C9 09     CMP #$09
C - - - - - 0x00460E 01:85FE: 90 04     BCC bra_8604
C - - - - - 0x004610 01:8600: A2 4C     LDX #< tbl_A54C_goal_team_1_gfx
C - - - - - 0x004612 01:8602: A0 A5     LDY #> tbl_A54C_goal_team_1_gfx
bra_8604:
...
C - - - - - 0x004622 01:8612: 9D 0D 03  STA ram_buffer_bg_hi,X
...
C - - - - - 0x00462C 01:861C: 9D 0E 03  STA ram_buffer_bg_lo,X
C - - - - - 0x00462F 01:861F: C8        INY
C - - - - - 0x004630 01:8620: B1 2A     LDA (ram_002A),Y
C - - - - - 0x004632 01:8622: 9D 0F 03  STA ram_buffer_bg_cnt,X
C - - - - - 0x004635 01:8625: C8        INY
bra_8626_loop:
C - - - - - 0x004636 01:8626: B1 2A     LDA (ram_002A),Y
C - - - - - 0x004638 01:8628: 9D 10 03  STA ram_buffer_bg_data,X
...
C - - - - - 0x004648 01:8638: 8D 7D 03  STA ram_buffer_bg_flag
...
C - - - - - 0x0046A3 01:8693: 91 61     STA (ram_plr_data),Y
bra_8695_RTS:
...
C - - - - - 0x0046EB 01:86DB: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x004779 01:8769: 20 7B C0  JSR sub_0x00F9B5
...
C - - - - - 0x0047AD 01:879D: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x0047B9 01:87A9: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x0047D0 01:87C0: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00483F 01:882F: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x004856 01:8846: D0 C4     BNE bra_880C_loop
...
C - - - - - 0x004879 01:8869: D0 E9     BNE bra_8854_loop
...
C - - - - - 0x0048C9 01:88B9: 90 02     BCC bra_88BD_team_1
...
C - - - - - 0x0048DE 01:88CE: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00492F 01:891F: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x004931 01:8921: 85 2A     STA ram_002A
C - - - - - 0x004933 01:8923: C8        INY ; con_plr_tbl_hi
C - - - - - 0x004934 01:8924: B1 61     LDA (ram_plr_data),Y
...
- D 0 - I - 0x004949 01:8939: 68 89     .word ofs_8968_03
- D 0 - I - 0x00494B 01:893B: B0 89     .word ofs_89B0_04
- - - - - - 0x00494D 01:893D: C0 89     .word ofs_89C0_05
- D 0 - I - 0x00494F 01:893F: EA 89     .word ofs_89EA_06
...
C - - - - - 0x004983 01:8973: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x0049D2 01:89C2: B1 61     LDA (ram_plr_data),Y
bra_89C4_loop:
...
C - - - - - 0x004A5B 01:8A4B: B9 27 B3  LDA tbl_B327_initial_speed,Y
C - - - - - 0x004A5E 01:8A4E: 85 77     STA ram_0077
C - - - - - 0x004A60 01:8A50: B9 28 B3  LDA tbl_B327_initial_speed + 1,Y
...
C - - - - - 0x004A86 01:8A76: 30 03     BMI bra_8A7B    ; con_gm_2p
...
C - - - - - 0x004AE3 01:8AD3: 20 57 C0  JSR sub_0x00CBF3_get_base_player_address
...
C - - - - - 0x004AF3 01:8AE3: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x004B11 01:8B01: BD 27 B3  LDA tbl_B327_initial_speed,X
C - - - - - 0x004B14 01:8B04: 91 61     STA (ram_plr_data),Y
C - - - - - 0x004B16 01:8B06: C8        INY ; con_plr_spd_lo_init
C - - - - - 0x004B17 01:8B07: BD 28 B3  LDA tbl_B327_initial_speed + 1,X
C - - - - - 0x004B1A 01:8B0A: 91 61     STA (ram_plr_data),Y
bra_8B0C:
...
C - - - - - 0x004B96 01:8B86: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x004B9E 01:8B8E: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x004BA9 01:8B99: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x004BBC 01:8BAC: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x004BC5 01:8BB5: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x004BF5 01:8BE5: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x004C61 01:8C51: B1 61     LDA (ram_plr_data),Y
...
- - - - - - 0x005956 01:9946: A6 A2     .word $0000         ; C0    ; 
- - - - - - 0x005958 01:9948: A7 A2     .word $0000         ; C1    ; 
- - - - - - 0x00595A 01:994A: A8 A2     .word $0000         ; C2    ; 
- - - - - - 0x00595C 01:994C: A9 A2     .word $0000         ; C3    ; 
- - - - - - 0x00595E 01:994E: AA A2     .word $0000         ; C4    ; 
- - - - - - 0x005960 01:9950: AB A2     .word $0000         ; C5    ; 
- - - - - - 0x005962 01:9952: AC A2     .word $0000         ; C6    ; 
- - - - - - 0x005964 01:9954: AD A2     .word $0000         ; C7    ; 
- - - - - - 0x005966 01:9956: AE A2     .word $0000         ; C8    ; 
- - - - - - 0x005968 01:9958: AF A2     .word $0000         ; C9    ; 
- - - - - - 0x00596A 01:995A: B0 A2     .word $0000         ; CA    ; 
- - - - - - 0x00596C 01:995C: B1 A2     .word $0000         ; CB    ; 
- - - - - - 0x00596E 01:995E: B2 A2     .word $0000         ; CC    ; 
- - - - - - 0x005970 01:9960: B3 A2     .word $0000         ; CD    ; 
- - - - - - 0x005972 01:9962: B4 A2     .word $0000         ; CE    ; 
- - - - - - 0x005974 01:9964: B5 A2     .word $0000         ; CF    ; 
- - - - - - 0x005976 01:9966: B6 A2     .word $0000         ; D0    ; 
- - - - - - 0x005978 01:9968: B7 A2     .word $0000         ; D1    ; 
- - - - - - 0x00597A 01:996A: B8 A2     .word $0000         ; D2    ; 
- - - - - - 0x00597C 01:996C: B9 A2     .word $0000         ; D3    ; 
- - - - - - 0x00597E 01:996E: BA A2     .word $0000         ; D4    ; 
- - - - - - 0x005980 01:9970: BB A2     .word $0000         ; D5    ; 
- - - - - - 0x005982 01:9972: BC A2     .word $0000         ; D6    ; 
- - - - - - 0x005984 01:9974: BD A2     .word $0000         ; D7    ; 
- - - - - - 0x005986 01:9976: BE A2     .word $0000         ; D8    ; 
- - - - - - 0x005988 01:9978: BF A2     .word $0000         ; D9    ; 
- - - - - - 0x00598A 01:997A: C0 A2     .word $0000         ; DA    ; 
- - - - - - 0x00598C 01:997C: C1 A2     .word $0000         ; DB    ; 
- - - - - - 0x00598E 01:997E: C2 A2     .word $0000         ; DC    ; 
...
tbl_A446_goal_net_hit:
; графика ворот при касании мячом сетки
...
- D 1 - I - 0x00647B 01:A46B: 59 22     .word $2259
- D 1 - I - 0x00647D 01:A46D: 40        .byte $40

- D 1 - I - 0x00647E 01:A46E: 01        .byte $01
- D 1 - I - 0x00647F 01:A46F: 79 22     .word $2279
...
- D 1 - I - 0x006484 01:A474: 3A 22     .word $223A
- D 1 - I - 0x006486 01:A476: 43        .byte $43

- D 1 - I - 0x006487 01:A477: 04        .byte $04
- D 1 - I - 0x006488 01:A478: 59 22     .word $2259
...
- D 1 - I - 0x006490 01:A480: 3B 22     .word $223B
- D 1 - I - 0x006492 01:A482: 48        .byte $48, $49

- D 1 - I - 0x006494 01:A484: 04        .byte $04
- D 1 - I - 0x006495 01:A485: 5A 22     .word $225A
...
- - - - - - 0x00649D 01:A48D: 3D 22     .word $223D
- - - - - - 0x00649F 01:A48F: 48        .byte $48, $49

- - - - - - 0x0064A1 01:A491: 04        .byte $04
- - - - - - 0x0064A2 01:A492: 5C 22     .word $225C
...
- - - - - - 0x0064BD 01:A4AD: 21 26     .word $2621
- - - - - - 0x0064BF 01:A4AF: 48        .byte $48, $49

- - - - - - 0x0064C1 01:A4B1: 04        .byte $04
- - - - - - 0x0064C2 01:A4B2: 40 26     .word $2640
...
- D 1 - I - 0x0064CA 01:A4BA: 23 26     .word $2623
- D 1 - I - 0x0064CC 01:A4BC: 48        .byte $48, $49

- D 1 - I - 0x0064CE 01:A4BE: 04        .byte $04
- D 1 - I - 0x0064CF 01:A4BF: 42 26     .word $2642
...
- D 1 - I - 0x0064D7 01:A4C7: 25 26     .word $2625
- D 1 - I - 0x0064D9 01:A4C9: 43        .byte $43

- D 1 - I - 0x0064DA 01:A4CA: 04        .byte $04
- D 1 - I - 0x0064DB 01:A4CB: 43 26     .word $2643
...
- - - - - - 0x0064E3 01:A4D3: 46 26     .word $2646
- - - - - - 0x0064E5 01:A4D5: 56        .byte $56

- - - - - - 0x0064E6 01:A4D6: 01        .byte $01
- - - - - - 0x0064E7 01:A4D7: 66 26     .word $2666
...
- D 1 - I - 0x0064EC 01:A4DC: 59 22     .word $2259
- D 1 - I - 0x0064EE 01:A4DE: 42        .byte $42

- D 1 - I - 0x0064EF 01:A4DF: 01        .byte $01
- D 1 - I - 0x0064F0 01:A4E0: 79 22     .word $2279
...
- D 1 - I - 0x0064F5 01:A4E5: 79 22     .word $2279
- D 1 - I - 0x0064F7 01:A4E7: 41        .byte $41, $44, $45, $4F

- D 1 - I - 0x0064FB 01:A4EB: 01        .byte $01
- D 1 - I - 0x0064FC 01:A4EC: 9A 22     .word $229A
...
- D 1 - I - 0x006501 01:A4F1: 7A 22     .word $227A
- D 1 - I - 0x006503 01:A4F3: 4A        .byte $4A, $4B, $4E, $4F

- D 1 - I - 0x006507 01:A4F7: 02        .byte $02
- D 1 - I - 0x006508 01:A4F8: 9B 22     .word $229B
...
- D 1 - I - 0x00650E 01:A4FE: 7C 22     .word $227C
- D 1 - I - 0x006510 01:A500: 4F        .byte $4F, $4B, $4E, $4F

- D 1 - I - 0x006514 01:A504: 02        .byte $02
- D 1 - I - 0x006515 01:A505: 9D 22     .word $229D
...
- D 1 - I - 0x00652E 01:A51E: 60 26     .word $2660
- D 1 - I - 0x006530 01:A520: 4F        .byte $4F, $4B, $4E, $4F

- D 1 - I - 0x006534 01:A524: 02        .byte $02
- D 1 - I - 0x006535 01:A525: 81 26     .word $2681
...
- D 1 - I - 0x00653B 01:A52B: 62 26     .word $2662
- D 1 - I - 0x00653D 01:A52D: 4F        .byte $4F, $4B, $4E, $50

- D 1 - I - 0x006541 01:A531: 02        .byte $02
- D 1 - I - 0x006542 01:A532: 83 26     .word $2683
...
- D 1 - I - 0x006548 01:A538: 63 26     .word $2663
- D 1 - I - 0x00654A 01:A53A: 4F        .byte $4F, $51, $54, $55

- D 1 - I - 0x00654E 01:A53E: 01        .byte $01
- D 1 - I - 0x00654F 01:A53F: 85 26     .word $2685
...
- D 1 - I - 0x006554 01:A544: 46 26     .word $2646
- D 1 - I - 0x006556 01:A546: 57        .byte $57

- D 1 - I - 0x006557 01:A547: 01        .byte $01
- D 1 - I - 0x006558 01:A548: 66 26     .word $2666
...
tbl_A54C_goal_team_1_gfx:
; графика ворот для команды снизу
- D 1 - I - 0x00655C 01:A54C: 08        .byte $08
- D 1 - I - 0x00655D 01:A54D: 58 22     .word $2258
- D 1 - I - 0x00655F 01:A54F: 00        .byte $00, $94, $B2, $B3, $B3, $B3, $B3, $B3

- D 1 - I - 0x006567 01:A557: 08        .byte $08
- D 1 - I - 0x006568 01:A558: 78 22     .word $2278
- D 1 - I - 0x00656A 01:A55A: 02        .byte $02, $96, $8A, $8B, $8B, $8B, $8E, $8F

- D 1 - I - 0x006572 01:A562: 08        .byte $08
- D 1 - I - 0x006573 01:A563: 98 22     .word $2298
- D 1 - I - 0x006575 01:A565: 09        .byte $09, $09, $09, $09, $09, $09, $09, $09

- D 1 - I - 0x00657D 01:A56D: 08        .byte $08
- D 1 - I - 0x00657E 01:A56E: 40 26     .word $2640
- D 1 - I - 0x006580 01:A570: B3        .byte $B3, $B3, $B3, $B3, $B3, $B6, $95, $00

- D 1 - I - 0x006588 01:A578: 08        .byte $08
- D 1 - I - 0x006589 01:A579: 60 26     .word $2660
- D 1 - I - 0x00658B 01:A57B: 9A        .byte $9A, $9B, $9E, $9E, $9E, $9F, $97, $02

- D 1 - I - 0x006593 01:A583: 08        .byte $08
- D 1 - I - 0x006594 01:A584: 80 26     .word $2680
- D 1 - I - 0x006596 01:A586: 09        .byte $09, $09, $09, $09, $09, $09, $09, $09

- D 1 - I - 0x00659E 01:A58E: 00        .byte $00



tbl_A58F_goal_team_2_gfx:
; графика ворот для команды сверху
- D 1 - I - 0x00659F 01:A58F: 08        .byte $08
- D 1 - I - 0x0065A0 01:A590: 38 22     .word $2238
- D 1 - I - 0x0065A2 01:A592: 0A        .byte $0A, $0A, $0A, $0A, $0A, $0A, $0A, $0A

- D 1 - I - 0x0065AA 01:A59A: 08        .byte $08
- D 1 - I - 0x0065AB 01:A59B: 58 22     .word $2258
- D 1 - I - 0x0065AD 01:A59D: 02        .byte $02, $90, $88, $89, $89, $89, $8C, $8D

- D 1 - I - 0x0065B5 01:A5A5: 08        .byte $08
- D 1 - I - 0x0065B6 01:A5A6: 78 22     .word $2278
- D 1 - I - 0x0065B8 01:A5A8: 00        .byte $00, $92, $B0, $B1, $B1, $B1, $B1, $B1

- D 1 - I - 0x0065C0 01:A5B0: 08        .byte $08
- D 1 - I - 0x0065C1 01:A5B1: 20 26     .word $2620
- D 1 - I - 0x0065C3 01:A5B3: 0A        .byte $0A, $0A, $0A, $0A, $0A, $0A, $0A, $0A

- D 1 - I - 0x0065CB 01:A5BB: 08        .byte $08
- D 1 - I - 0x0065CC 01:A5BC: 40 26     .word $2640
- D 1 - I - 0x0065CE 01:A5BE: 98        .byte $98, $99, $9C, $9C, $9C, $9D, $91, $02

- D 1 - I - 0x0065D6 01:A5C6: 08        .byte $08
- D 1 - I - 0x0065D7 01:A5C7: 60 26     .word $2660
- D 1 - I - 0x0065D9 01:A5C9: B1        .byte $B1, $B1, $B1, $B1, $B1, $B4, $93, $00
...
tbl_B327_initial_speed:
- - - - - - 0x007337 01:B327: 14 01     .word $0114     ; 00
- D 1 - - - 0x007339 01:B329: 16 01     .word $0116     ; 01
- - - - - - 0x00733B 01:B32B: 18 01     .word $0118     ; 02
- D 1 - - - 0x00733D 01:B32D: 1A 01     .word $011A     ; 03
- D 1 - - - 0x00733F 01:B32F: 1C 01     .word $011C     ; 04
- D 1 - - - 0x007341 01:B331: 20 01     .word $0120     ; 05
- D 1 - - - 0x007343 01:B333: 24 01     .word $0124     ; 06
- D 1 - - - 0x007345 01:B335: 26 01     .word $0126     ; 07
- D 1 - - - 0x007347 01:B337: 28 01     .word $0128     ; 08
- D 1 - - - 0x007349 01:B339: 30 01     .word $0130     ; 09
- - - - - - 0x00734B 01:B33B: 90 01     .word $0190     ; 0A
- D 1 - - - 0x00734D 01:B33D: A0 01     .word $01A0     ; 0B
- D 1 - - - 0x00734F 01:B33F: B0 01     .word $01B0     ; 0C
- D 1 - - - 0x007351 01:B341: C0 01     .word $01C0     ; 0D
- D 1 - - - 0x007353 01:B343: D0 01     .word $01D0     ; 0E
- D 1 - - - 0x007355 01:B345: E0 01     .word $01E0     ; 0F

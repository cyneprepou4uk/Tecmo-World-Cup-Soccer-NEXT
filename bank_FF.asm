...
.export sub_0x00C762
.export sub_0x00C8AD
.export sub_0x00C920_prepare_sound
.export sub_0x00C92E_EOR_16bit
...
.export sub_0x00CAE4_load_screen_palette
.export sub_0x00CB5A
.export sub_0x00CB60
...
C - - - - - 0x00C120 03:C110: 8D 81 03  STA ram_buffer_pal_lo
C - - - - - 0x00C123 03:C113: A9 3F     LDA #$3F
C - - - - - 0x00C125 03:C115: 8D 82 03  STA ram_buffer_pal_cnt
C - - - - - 0x00C128 03:C118: A2 00     LDX #$00
C - - - - - 0x00C12A 03:C11A: A9 00     LDA #$00
C - - - - - 0x00C12C 03:C11C: 20 D4 CA  JSR sub_CAD4_load_screen_palette
C - - - - - 0x00C12F 03:C11F: A2 10     LDX #$10
C - - - - - 0x00C131 03:C121: A9 01     LDA #$01
C - - - - - 0x00C133 03:C123: 20 D4 CA  JSR sub_CAD4_load_screen_palette
...
sub_C1EB:
C - - - - - 0x00C1FB 03:C1EB: AD 00 03  LDA ram_buffer_pal_flag
C - - - - - 0x00C1FE 03:C1EE: F0 37     BEQ bra_C227
C - - - - - 0x00C200 03:C1F0: CE 00 03  DEC ram_buffer_pal_flag
                                        LDA #< ram_buffer_pal_hi
...
bra_C227:
C - - - - - 0x00C237 03:C227: AD 7D 03  LDA ram_buffer_bg_flag
C - - - - - 0x00C23A 03:C22A: 10 2B     BPL bra_C257_RTS
C - - - - - 0x00C23C 03:C22C: A2 00     LDX #$00
C - - - - - 0x00C23E 03:C22E: 8E 7D 03  STX ram_buffer_bg_flag
bra_C231:
C - - - - - 0x00C241 03:C231: BD 0D 03  LDA ram_buffer_bg_hi,X
C - - - - - 0x00C244 03:C234: F0 21     BEQ bra_C257_RTS
C - - - - - 0x00C246 03:C236: A8        TAY
C - - - - - 0x00C247 03:C237: E8        INX
C - - - - - 0x00C248 03:C238: BD 0D 03  LDA ram_buffer_bg_hi,X
C - - - - - 0x00C24B 03:C23B: 48        PHA
C - - - - - 0x00C24C 03:C23C: E8        INX
C - - - - - 0x00C24D 03:C23D: BD 0D 03  LDA ram_buffer_bg_hi,X
...
bra_C24B:
C - - - - - 0x00C25B 03:C24B: BD 0D 03  LDA ram_buffer_bg_hi,X
...
C - - - - - 0x00C26A 03:C25A: AD 24 00  LDA ram_btn_hold
C - - - - - 0x00C26D 03:C25D: 20 68 C2  JSR sub_C268
C - - - - - 0x00C270 03:C260: E8        INX
C - - - - - 0x00C271 03:C261: AD 25 00  LDA ram_btn_hold + 1
...
bra_C292:
C - - - - - 0x00C2A2 03:C292: BD 24 00  LDA ram_btn_hold,X
C - - - - - 0x00C2A5 03:C295: 45 45     EOR ram_0045
C - - - - - 0x00C2A7 03:C297: 25 45     AND ram_0045
C - - - - - 0x00C2A9 03:C299: 9D 26 00  STA ram_btn_press,X
C - - - - - 0x00C2AC 03:C29C: A5 45     LDA ram_0045
C - - - - - 0x00C2AE 03:C29E: 9D 24 00  STA ram_btn_hold,X
bra_C2A1_RTS:
...
C - - - - - 0x00C337 03:C327: 2D 26 00  AND ram_btn_press
...
C - - - - - 0x00C354 03:C344: 85 67     STA ram_prg_bank_0
C - - - - - 0x00C356 03:C346: A9 05     LDA #$05
C - - - - - 0x00C358 03:C348: 85 68     STA ram_prg_bank_1
...
C - - - - - 0x00C364 03:C354: 85 67     STA ram_prg_bank_0
C - - - - - 0x00C366 03:C356: A9 05     LDA #$05
C - - - - - 0x00C368 03:C358: 85 68     STA ram_prg_bank_1
...
loc_C36E_continue_walkrthough:      ; переход сюда если играть против компа и победить/проиграть
C D 2 - - - 0x00C37E 03:C36E: A9 01     LDA #con_sound_off
...
C - - - - - 0x00C390 03:C380: 8D A8 03  STA ram_goals_total + 1
C - - - - - 0x00C393 03:C383: 8D 8F 00  STA ram_goals_pk
C - - - - - 0x00C396 03:C386: 8D 90 00  STA ram_goals_pk + 1
C - - - - - 0x00C399 03:C389: 8D A5 03  STA ram_goals_half
C - - - - - 0x00C39C 03:C38C: 8D A6 03  STA ram_goals_half + 1
...
C - - - - - 0x00C3A8 03:C398: 85 67     STA ram_prg_bank_0
C - - - - - 0x00C3AA 03:C39A: A9 05     LDA #$05
C - - - - - 0x00C3AC 03:C39C: 85 68     STA ram_prg_bank_1
...
C - - - - - 0x00C3B8 03:C3A8: 85 67     STA ram_prg_bank_0
C - - - - - 0x00C3BA 03:C3AA: A9 05     LDA #$05
C - - - - - 0x00C3BC 03:C3AC: 85 68     STA ram_prg_bank_1
...
C - - - - - 0x00C3C8 03:C3B8: 85 67     STA ram_prg_bank_0
...
C - - - - - 0x00C3FA 03:C3EA: AD A4 03  LDA ram_game_mode_flags
C - - - - - 0x00C3FD 03:C3ED: 29 01     AND #con_gm_timeup
...
C - - - - - 0x00C414 03:C404: A9 CE     LDA #> ofs_CE73
...
C - - - - - 0x00C43A 03:C42A: CD A8 03  CMP ram_goals_total + 1
...
C - - - - - 0x00C44F 03:C43F: 8D A4 03  STA ram_game_mode_flags
C - - - - - 0x00C452 03:C442: 68        PLA
C - - - - - 0x00C453 03:C443: 68        PLA
C - - - - - 0x00C454 03:C444: 2C A4 03  BIT ram_game_mode_flags
C - - - - - 0x00C457 03:C447: 10 03     BPL bra_C44C    ; con_gm_1p
...
bra_C459:
C - - - - - 0x00C469 03:C459: 4C 6E C3  JMP loc_C36E_continue_walkrthough
bra_C45C_RTS:
...
C - - - - - 0x00C4B8 03:C4A8: A9 0B     LDA #con_sound_time_up
...
C - - - - - 0x00C4DE 03:C4CE: 20 D4 CA  JSR sub_CAD4_load_screen_palette
C - - - - - 0x00C4E1 03:C4D1: A2 10     LDX #$10
C - - - - - 0x00C4E3 03:C4D3: A9 08     LDA #$08
C - - - - - 0x00C4E5 03:C4D5: 20 D4 CA  JSR sub_CAD4_load_screen_palette
                                        INC ram_buffer_pal_flag
...
C - - - - - 0x00C4FB 03:C4EB: 9D 6B 00  STA ram_006B,X
...
C - - - - - 0x00C509 03:C4F9: 85 67     STA ram_prg_bank_0
C - - - - - 0x00C50B 03:C4FB: A9 05     LDA #$05
C - - - - - 0x00C50D 03:C4FD: 85 68     STA ram_prg_bank_1
...
C - - - - - 0x00C558 03:C548: A9 CC     LDA #> ofs_CCC4
C - - - - - 0x00C55A 03:C54A: A0 C3     LDY #< ofs_CCC4
C - - - - - 0x00C55C 03:C54C: 20 E1 C5  JSR sub_C5E1_prepare_return_address
C - - - - - 0x00C55F 03:C54F: AD A4 03  LDA ram_game_mode_flags
C - - - - - 0x00C562 03:C552: 29 DE     AND #(con_gm_timeup + con_gm_out_of_play) ^ $FF
C - - - - - 0x00C564 03:C554: 8D A4 03  STA ram_game_mode_flags
...
C - - - - - 0x00C5E2 03:C5D2: 85 67     STA ram_prg_bank_0
C - - - - - 0x00C5E4 03:C5D4: 18        CLC
C - - - - - 0x00C5E5 03:C5D5: 69 01     ADC #$01
C - - - - - 0x00C5E7 03:C5D7: 85 68     STA ram_prg_bank_1
...
C - - - - - 0x00C5CD 03:C5BD: 85 68     STA ram_prg_bank_1
...
C - - - - - 0x00C5C0 03:C5B0: F0 F1     BEQ bra_C5A3_loop
...
C - - - - - 0x00C621 03:C611: A5 67     LDA ram_prg_bank_0
C - - - - - 0x00C623 03:C613: 95 02     STA ram_0002,X
C - - - - - 0x00C625 03:C615: A5 68     LDA ram_prg_bank_1
...
C - - - - - 0x00C642 03:C632: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00C644 03:C634: 29 04     AND #con_player_flag_control
C - - - - - 0x00C646 03:C636: D0 19     BNE bra_C651_RTS
C - - - - - 0x00C648 03:C638: 8A        TXA
C - - - - - 0x00C649 03:C639: A0 12     LDY #con_plr_behavior
C - - - - - 0x00C64B 03:C63B: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00C64D 03:C63D: 0A        ASL
C - - - - - 0x00C64E 03:C63E: AA        TAX
C - - - - - 0x00C64F 03:C63F: BD C3 E6  LDA tbl_E6C2_player_state_subroutine + 1,X
C - - - - - 0x00C652 03:C642: A0 16     LDY #con_plr_sub_hi
C - - - - - 0x00C654 03:C644: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00C656 03:C646: C8        INY ; con_plr_sub_lo
C - - - - - 0x00C657 03:C647: BD C2 E6  LDA tbl_E6C2_player_state_subroutine,X
C - - - - - 0x00C65A 03:C64A: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00C65C 03:C64C: A9 01     LDA #$01
C - - - - - 0x00C65E 03:C64E: C8        INY ; con_plr_sub_timer
C - - - - - 0x00C65F 03:C64F: 91 61     STA (ram_plr_data),Y
bra_C651_RTS:
...
C - - - - - 0x00C668 03:C658: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00C66A 03:C65A: 88        DEY ; con_plr_sub_hi
C - - - - - 0x00C66B 03:C65B: 68        PLA
C - - - - - 0x00C66C 03:C65C: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00C66E 03:C65E: 4C 55 DF  JMP loc_DF55_check_next_player



sub_C66D:
C - - - - - 0x00C67D 03:C66D: A0 0F     LDY #con_plr_anim_cnt_hi
C - - - - - 0x00C67F 03:C66F: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00C681 03:C671: 18        CLC
C - - - - - 0x00C682 03:C672: 69 01     ADC #$01
C - - - - - 0x00C684 03:C674: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00C686 03:C676: 60        RTS



sub_C677:
C - - - - - 0x00C687 03:C677: A0 0F     LDY #con_plr_anim_cnt_hi
C - - - - - 0x00C689 03:C679: A9 00     LDA #$00
C - - - - - 0x00C68B 03:C67B: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00C68D 03:C67D: 60        RTS



sub_C67E:
C - - - - - 0x00C68E 03:C67E: A0 14     LDY #con_plr_spd_fr_init
C - - - - - 0x00C690 03:C680: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00C692 03:C682: 85 2A     STA ram_002A
C - - - - - 0x00C694 03:C684: C8        INY ; con_plr_spd_lo_init
C - - - - - 0x00C695 03:C685: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00C6A6 03:C696: A0 10     LDY #con_plr_anim_cnt_lo
C - - - - - 0x00C6A8 03:C698: 18        CLC
C - - - - - 0x00C6A9 03:C699: 71 61     ADC (ram_plr_data),Y
C - - - - - 0x00C6AB 03:C69B: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00C6AD 03:C69D: 90 19     BCC bra_C6B8_RTS
C - - - - - 0x00C6AF 03:C69F: 88        DEY ; con_plr_anim_cnt_hi
C - - - - - 0x00C6B0 03:C6A0: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00C6B2 03:C6A2: 18        CLC
C - - - - - 0x00C6B3 03:C6A3: 69 01     ADC #$01
C - - - - - 0x00C6B5 03:C6A5: 29 03     AND #$03
C - - - - - 0x00C6B7 03:C6A7: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00C6B9 03:C6A9: A9 04     LDA #$04
C - - - - - 0x00C6BB 03:C6AB: A4 6F     LDY ram_006F
C - - - - - 0x00C6BD 03:C6AD: F0 06     BEQ bra_C6B5
C - - - - - 0x00C6BF 03:C6AF: C0 0B     CPY #$0B
C - - - - - 0x00C6C1 03:C6B1: F0 02     BEQ bra_C6B5
C - - - - - 0x00C6C3 03:C6B3: A9 03     LDA #$03
bra_C6B5:
C - - - - - 0x00C6C5 03:C6B5: 20 1E 80  JSR sub_0x00479F
bra_C6B8_RTS:
...
C - - - - - 0x00C6D0 03:C6C0: 90 02     BCC bra_C6C4_team_1
...
C - - - - - 0x00C701 03:C6F1: A9 00     LDA #con_behavior_idle
C - - - - - 0x00C703 03:C6F3: 20 2F C6  JSR sub_C62F_player_state_handler
bra_C6F6:
...
C - - - - - 0x00C71B 03:C70B: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00C71D 03:C70D: 29 04     AND #con_player_flag_control
C - - - - - 0x00C71F 03:C70F: D0 06     BNE bra_C717
C - - - - - 0x00C721 03:C711: A9 04     LDA #con_behavior_wo_ball
C - - - - - 0x00C723 03:C713: 20 2F C6  JSR sub_C62F_player_state_handler
...
C - - - - - 0x00C772 03:C762: AD 7D 03  LDA ram_buffer_bg_flag
C - - - - - 0x00C775 03:C765: D0 F6     BNE bra_C75D_wait_loop
C - - - - - 0x00C777 03:C767: A9 01     LDA #$01
C - - - - - 0x00C779 03:C769: 8D 7D 03  STA ram_buffer_bg_flag
C - - - - - 0x00C77C 03:C76C: 68        PLA
C - - - - - 0x00C77D 03:C76D: AA        TAX
C - - - - - 0x00C77E 03:C76E: 8D 0D 03  STA ram_buffer_bg_hi
C - - - - - 0x00C781 03:C771: C8        INY
C - - - - - 0x00C782 03:C772: B1 43     LDA (ram_0043),Y
C - - - - - 0x00C784 03:C774: 8D 0E 03  STA ram_buffer_bg_lo
C - - - - - 0x00C787 03:C777: C8        INY
C - - - - - 0x00C788 03:C778: B1 43     LDA (ram_0043),Y
C - - - - - 0x00C78A 03:C77A: 8D 0F 03  STA ram_buffer_bg_cnt
C - - - - - 0x00C78D 03:C77D: C8        INY
bra_C77E:
C - - - - - 0x00C78E 03:C77E: B1 43     LDA (ram_0043),Y
C - - - - - 0x00C790 03:C780: 99 0D 03  STA ram_buffer_bg_hi,Y
C - - - - - 0x00C793 03:C783: C8        INY
C - - - - - 0x00C794 03:C784: CA        DEX
C - - - - - 0x00C795 03:C785: D0 F7     BNE bra_C77E
C - - - - - 0x00C797 03:C787: 8A        TXA
C - - - - - 0x00C798 03:C788: 99 0D 03  STA ram_buffer_bg_hi,Y
...
C - - - - - 0x00C7A7 03:C797: 8D 7D 03  STA ram_buffer_bg_flag
...
C - - - - - 0x00C7B6 03:C7A6: A0 13     LDY #con_plr_direction
C - - - - - 0x00C7B8 03:C7A8: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00C7CE 03:C7BE: A0 01     LDY #con_plr_spr_A
C - - - - - 0x00C7D0 03:C7C0: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00C7E1 03:C7D1: A0 05     LDY #con_plr_pos_X_lo
C - - - - - 0x00C7E3 03:C7D3: 18        CLC
C - - - - - 0x00C7E4 03:C7D4: 71 61     ADC (ram_plr_data),Y
C - - - - - 0x00C7E6 03:C7D6: 8D D8 03  STA ram_ball_pos_X_lo
C - - - - - 0x00C7E9 03:C7D9: C8        INY
C - - - - - 0x00C7EA 03:C7DA: C8        INY ; con_plr_pos_X_hi
...
C - - - - - 0x00C7F2 03:C7E2: 71 61     ADC (ram_plr_data),Y
C - - - - - 0x00C7F4 03:C7E4: 8D DA 03  STA ram_ball_pos_X_hi
C - - - - - 0x00C7F7 03:C7E7: A0 01     LDY #con_plr_spr_A
C - - - - - 0x00C7F9 03:C7E9: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00C80A 03:C7FA: A0 0B     LDY #con_plr_pos_Y_lo
C - - - - - 0x00C80C 03:C7FC: 18        CLC
C - - - - - 0x00C80D 03:C7FD: 71 61     ADC (ram_plr_data),Y
C - - - - - 0x00C80F 03:C7FF: 8D DE 03  STA ram_ball_pos_Y_lo
C - - - - - 0x00C812 03:C802: C8        INY
C - - - - - 0x00C813 03:C803: C8        INY ; con_plr_pos_Y_hi
...
C - - - - - 0x00C81B 03:C80B: 71 61     ADC (ram_plr_data),Y
C - - - - - 0x00C81D 03:C80D: 8D E0 03  STA ram_ball_pos_Y_hi
...
C - - - - - 0x00C856 03:C846: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00C858 03:C848: E9 10     SBC #$10
C - - - - - 0x00C85A 03:C84A: AA        TAX
C - - - - - 0x00C85B 03:C84B: C8        INY
C - - - - - 0x00C85C 03:C84C: C8        INY ; con_plr_pos_X_hi
C - - - - - 0x00C85D 03:C84D: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00C883 03:C873: A0 0B     LDY #con_plr_pos_Y_lo
C - - - - - 0x00C885 03:C875: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00C887 03:C877: E9 98     SBC #$98
C - - - - - 0x00C889 03:C879: AA        TAX
C - - - - - 0x00C88A 03:C87A: C8        INY
C - - - - - 0x00C88B 03:C87B: C8        INY ; con_plr_pos_Y_hi
C - - - - - 0x00C88C 03:C87C: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00C8C5 03:C8B5: A0 1B     LDY #con_plr_aim_X_hi
C - - - - - 0x00C8C7 03:C8B7: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00C8C9 03:C8B9: 88        DEY ; con_plr_aim_X_lo
C - - - - - 0x00C8CA 03:C8BA: 8A        TXA
C - - - - - 0x00C8CB 03:C8BB: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00C8DA 03:C8CA: A0 1D     LDY #con_plr_aim_Y_hi
C - - - - - 0x00C8DC 03:C8CC: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00C8DE 03:C8CE: 88        DEY ; con_plr_aim_Y_lo
C - - - - - 0x00C8DF 03:C8CF: 8A        TXA
C - - - - - 0x00C8E0 03:C8D0: 91 61     STA (ram_plr_data),Y
...
sub_0x00C920_prepare_sound:
C D 2 - - - 0x00C920 03:C910: AC 00 07  LDY ram_sound_cnt
C - - - - - 0x00C923 03:C913: C0 04     CPY #$04    ; если буфер заполнен
...
sub_C937_set_player_flag___unknown:
    LDY #con_plr_flags
    LDA (ram_plr_data),Y
    ORA #con_player_flag_unknown_01
    STA (ram_plr_data),Y
    RTS
...
sub_0x00C94B_set_player_flag___control:
    LDY #con_plr_flags
    LDA (ram_plr_data),Y
    ORA #con_player_flag_control
    AND #con_player_flag_busy ^ $FF
    STA (ram_plr_data),Y
    RTS
...
sub_C93F_clear_player_flag___unknown:
    LDY #con_plr_flags
    LDA (ram_plr_data),Y
    AND #con_player_flag_unknown_01 ^ $FF
    STA (ram_plr_data),Y
    RTS
...
sub_0x00C951_clear_player_flag___visible:
    LDY #con_plr_flags
    LDA (ram_plr_data),Y
    AND #con_player_flag_visible ^ $FF
    STA (ram_plr_data),Y
    RTS
...
sub_0x00C953_clear_player_flag___control:
    LDY #con_plr_flags
    LDA (ram_plr_data),Y
    AND #con_player_flag_control ^ $FF
    STA (ram_plr_data),Y
    RTS

sub_C945_clear_player_flag___all:
    LDY #con_plr_flags
    LDA (ram_plr_data),Y
    AND #con_player_flags_all ^ $FF
    STA (ram_plr_data),Y
    RTS
...
C - - - - - 0x00C984 03:C974: A0 00     LDY #con_plr_flags
C - - - - - 0x00C986 03:C976: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00C988 03:C978: 29 04     AND #con_player_flag_control
...
C - - - - - 0x00C9AD 03:C99D: ED D8 03  SBC ram_ball_pos_X_lo
C - - - - - 0x00C9B0 03:C9A0: AA        TAX
C - - - - - 0x00C9B1 03:C9A1: C8        INY
C - - - - - 0x00C9B2 03:C9A2: C8        INY ; con_plr_pos_X_hi
C - - - - - 0x00C9B3 03:C9A3: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00C9B5 03:C9A5: ED DA 03  SBC ram_ball_pos_X_hi
C - - - - - 0x00C9B8 03:C9A8: A8        TAY
C - - - - - 0x00C9B9 03:C9A9: B0 03     BCS bra_C9AE
C - - - - - 0x00C9BB 03:C9AB: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_C9AE:
...
C - - - - - 0x00C9C7 03:C9B7: A0 0B     LDY #con_plr_pos_Y_lo
C - - - - - 0x00C9C9 03:C9B9: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00C9CB 03:C9BB: 38        SEC
C - - - - - 0x00C9CC 03:C9BC: ED DE 03  SBC ram_ball_pos_Y_lo
C - - - - - 0x00C9CF 03:C9BF: AA        TAX
C - - - - - 0x00C9D0 03:C9C0: C8        INY
C - - - - - 0x00C9D1 03:C9C1: C8        INY ; con_plr_pos_Y_hi
C - - - - - 0x00C9D2 03:C9C2: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00C9D4 03:C9C4: ED E0 03  SBC ram_ball_pos_Y_hi
C - - - - - 0x00C9D7 03:C9C7: A8        TAY
C - - - - - 0x00C9D8 03:C9C8: B0 03     BCS bra_C9CD
C - - - - - 0x00C9DA 03:C9CA: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_C9CD:
...
C - - - - - 0x00CA03 03:C9F3: A0 00     LDY #con_plr_flags
C - - - - - 0x00CA05 03:C9F5: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00CA07 03:C9F7: 29 04     AND #con_player_flag_control
...
C - - - - - 0x00CA31 03:CA21: C8        INY ; con_plr_pos_X_hi
C - - - - - 0x00CA32 03:CA22: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00CA34 03:CA24: ED 14 04  SBC ram_ball_land_pos_X_hi
C - - - - - 0x00CA37 03:CA27: A8        TAY
C - - - - - 0x00CA38 03:CA28: B0 03     BCS bra_CA2D
C - - - - - 0x00CA3A 03:CA2A: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_CA2D:
...
C - - - - - 0x00CA46 03:CA36: A0 0B     LDY #con_plr_pos_Y_lo
C - - - - - 0x00CA48 03:CA38: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00CA50 03:CA40: C8        INY ; con_plr_pos_Y_hi
C - - - - - 0x00CA51 03:CA41: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00CA53 03:CA43: ED 16 04  SBC ram_ball_land_pos_Y_hi
C - - - - - 0x00CA56 03:CA46: A8        TAY
C - - - - - 0x00CA57 03:CA47: B0 03     BCS bra_CA4C
C - - - - - 0x00CA59 03:CA49: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_CA4C:
...
sub_CAD4_load_screen_palette:
sub_0x00CAE4_load_screen_palette:
...
C - - - - - 0x00CB08 03:CAF8: 8D 80 03  STA ram_buffer_pal_hi
...
bra_CB09:
C - - - - - 0x00CB19 03:CB09: 9D 83 03  STA ram_buffer_pal_data,X
C - - - - - 0x00CB1C 03:CB0C: E8        INX
C - - - - - 0x00CB1D 03:CB0D: CE 80 03  DEC ram_buffer_pal_hi
C - - - - - 0x00CB20 03:CB10: D0 EB     BNE bra_CAFD_loop
C - - - - - 0x00CB22 03:CB12: A9 20     LDA #$20
C - - - - - 0x00CB24 03:CB14: 8D 80 03  STA ram_buffer_pal_hi
...
sub_CB4A:
sub_0x00CB5A:
C D 2 - - - 0x00CB5A 03:CB4A: 20 1E C9  JSR sub_C91E_EOR_16bit
...
sub_CB50:
sub_0x00CB60:
C D 2 - - - 0x00CB60 03:CB50: 20 1E C9  JSR sub_C91E_EOR_16bit
...
C - - - - - 0x00CBF8 03:CBE8: 85 61     STA ram_plr_data
C - - - - - 0x00CBFA 03:CBEA: BD F1 CB  LDA tbl_CBF0_address + 1,X
C - - - - - 0x00CBFD 03:CBED: 85 62     STA ram_plr_data + 1
...
C - - - - - 0x00CC3C 03:CC2C: BD 45 CC  LDA tbl_CC44 + 1,X
...
C - - - - - 0x00CCE6 03:CCD6: 20 D4 CA  JSR sub_CAD4_load_screen_palette
C - - - - - 0x00CCE9 03:CCD9: A2 10     LDX #$10
C - - - - - 0x00CCEB 03:CCDB: A9 02     LDA #$02
C - - - - - 0x00CCED 03:CCDD: 20 D4 CA  JSR sub_CAD4_load_screen_palette
                                        INC ram_buffer_pal_flag
...
C - - - - - 0x00CD05 03:CCF5: 85 67     STA ram_prg_bank_0
...
C - - - - - 0x00CD2D 03:CD1D: A9 E4     LDA #> ofs_E4D9
C - - - - - 0x00CD2F 03:CD1F: A0 D8     LDY #< ofs_E4D9
...
C - - - - - 0x00CD51 03:CD41: A9 13     LDA #con_behavior_13
C - - - - - 0x00CD53 03:CD43: 20 2F C6  JSR sub_C62F_player_state_handler
                                        JSR sub_C93B_set_player_flag___control
C - - - - - 0x00CD60 03:CD50: AD A4 03  LDA ram_game_mode_flags
C - - - - - 0x00CD63 03:CD53: 09 20     ORA #con_gm_out_of_play
C - - - - - 0x00CD65 03:CD55: 8D A4 03  STA ram_game_mode_flags
...
C - - - - - 0x00CD9F 03:CD8F: 85 67     STA ram_prg_bank_0
...
C - - - - - 0x00CDB3 03:CDA3: 85 68     STA ram_prg_bank_1
...
C - - - - - 0x00CDD9 03:CDC9: 85 67     STA ram_prg_bank_0
...
C - - - - - 0x00CDED 03:CDDD: 85 68     STA ram_prg_bank_1
...
C - - - - - 0x00CE04 03:CDF4: 85 67     STA ram_prg_bank_0
C - - - - - 0x00CE06 03:CDF6: A9 03     LDA #$03
C - - - - - 0x00CE08 03:CDF8: 85 68     STA ram_prg_bank_1
...
C - - - - - 0x00CE1C 03:CE0C: A9 01     LDA #con_gm_timeup
C - - - - - 0x00CE1E 03:CE0E: 0D A4 03  ORA ram_game_mode_flags
C - - - - - 0x00CE21 03:CE11: 8D A4 03  STA ram_game_mode_flags
...
C - - - - - 0x00CE36 03:CE26: 20 E3 CB  JSR sub_CBE3_get_base_player_address
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00CE41 03:CE31: A9 00     LDA #con_behavior_idle
C - - - - - 0x00CE43 03:CE33: 20 2F C6  JSR sub_C62F_player_state_handler
bra_CE36:
...
C - - - - - 0x00CE54 03:CE44: 85 67     STA ram_prg_bank_0
C - - - - - 0x00CE56 03:CE46: A9 03     LDA #$03
C - - - - - 0x00CE58 03:CE48: 85 68     STA ram_prg_bank_1
...
C - - - - - 0x00CE8F 03:CE7F: 20 D4 CA  JSR sub_CAD4_load_screen_palette
C - - - - - 0x00CE92 03:CE82: A2 10     LDX #$10
C - - - - - 0x00CE94 03:CE84: A9 02     LDA #$02
C - - - - - 0x00CE96 03:CE86: 20 D4 CA  JSR sub_CAD4_load_screen_palette
C - - - - - 0x00CE99 03:CE89: 48        PHA
C - - - - - 0x00CE9A 03:CE8A: A9 04     LDA #$04
C - - - - - 0x00CE9C 03:CE8C: 85 67     STA ram_prg_bank_0
...
bra_CEB0_loop:
C - - - - - 0x00CEC0 03:CEB0: 9D 83 03  STA ram_buffer_pal_data,X
...
C - - - - - 0x00CF11 03:CF01: 85 67     STA ram_prg_bank_0
C - - - - - 0x00CF13 03:CF03: A9 05     LDA #$05
C - - - - - 0x00CF15 03:CF05: 85 68     STA ram_prg_bank_1
...
C - - - - - 0x00CF25 03:CF15: E5 90     SBC ram_goals_pk + 1
...
C - - - - - 0x00CF6B 03:CF5B: 2D 26 00  AND ram_btn_press
C - - - - - 0x00CF6E 03:CF5E: D0 0B     BNE bra_CF6B
C - - - - - 0x00CF70 03:CF60: A9 C0     LDA #con_btns_AB
C - - - - - 0x00CF72 03:CF62: 2D 27 00  AND ram_btn_press + 1
...
C - - - - - 0x00CFAC 03:CF9C: 9D 83 03  STA ram_buffer_pal_data,X
...
C - - - - - 0x00CFB7 03:CFA7: 85 67     STA ram_prg_bank_0
...
C - - - - - 0x00CFC1 03:CFB1: 20 21 80  JSR sub_0x004531_team_palette
                                        INC ram_buffer_pal_flag
...
tbl_CFBA_palette:
- D 2 - - - 0x00CFCA 03:CFBA: 0A        .byte $0A, $0F, $1A, $30   ; 
- D 2 - - - 0x00CFCE 03:CFBE: 0A        .byte $0A, $0F, $25, $36   ; 
- D 2 - - - 0x00CFD2 03:CFC2: 0A        .byte $0A, $0F, $21, $36   ; 
- D 2 - - - 0x00CFD6 03:CFC6: 0A        .byte $0A, $16, $26, $36   ; 
- D 2 - - - 0x00CFDA 03:CFCA: 0A        .byte $0A, $30, $16, $35   ; 
- D 2 - - - 0x00CFDE 03:CFCE: 0A        .byte $0A, $0F, $0F, $30   ; 
- D 2 - - - 0x00CFE2 03:CFD2: 0A        .byte $0A, $2B, $11, $26   ; 
- D 2 - - - 0x00CFE6 03:CFD6: 0A        .byte $0A, $28, $0F, $30   ; 
...
C - - - - - 0x00CFFC 03:CFEC: 2C A4 03  BIT ram_game_mode_flags
C - - - - - 0x00CFFF 03:CFEF: 30 03     BMI bra_CFF4    ; con_gm_2p
...
C - - - - - 0x00D00C 03:CFFC: A0 12     LDY #con_plr_behavior
C - - - - - 0x00D00E 03:CFFE: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00D010 03:D000: C9 04     CMP #con_behavior_wo_ball
C - - - - - 0x00D012 03:D002: D0 15     BNE bra_D019
C - - - - - 0x00D014 03:D004: A0 00     LDY #con_plr_flags
C - - - - - 0x00D016 03:D006: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00D018 03:D008: 29 02     AND #con_player_flag_visible
C - - - - - 0x00D01A 03:D00A: D0 67     BNE bra_D073_RTS
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00D024 03:D014: A9 00     LDA #con_behavior_idle
C - - - - - 0x00D026 03:D016: 20 2F C6  JSR sub_C62F_player_state_handler
bra_D019:
...
C - - - - - 0x00D03F 03:D02F: A0 00     LDY #con_plr_flags
C - - - - - 0x00D041 03:D031: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00D043 03:D033: AA        TAX
C - - - - - 0x00D044 03:D034: 29 02     AND #con_player_flag_visible
C - - - - - 0x00D046 03:D036: F0 07     BEQ bra_D03F
C - - - - - 0x00D048 03:D038: 8A        TXA
C - - - - - 0x00D049 03:D039: 29 04     AND #con_player_flag_control
...
C - - - - - 0x00D06C 03:D05C: A0 00     LDY #con_plr_flags
C - - - - - 0x00D06E 03:D05E: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00D070 03:D060: 29 04     AND #con_player_flag_control
C - - - - - 0x00D072 03:D062: D0 10     BNE bra_D074
C - - - - - 0x00D074 03:D064: A9 04     LDA #con_behavior_wo_ball
C - - - - - 0x00D076 03:D066: 20 2F C6  JSR sub_C62F_player_state_handler
                                        JSR sub_C93B_set_player_flag___control
bra_D073_RTS:
...
C - - - - - 0x00D0AF 03:D09F: AE DE 03  LDX ram_ball_pos_Y_lo
C - - - - - 0x00D0B2 03:D0A2: AC E0 03  LDY ram_ball_pos_Y_hi
...
C - - - - - 0x00D0DF 03:D0CF: AD DA 03  LDA ram_ball_pos_X_hi
...
C - - - - - 0x00D0EC 03:D0DC: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00D0EE 03:D0DE: C8        INY
C - - - - - 0x00D0EF 03:D0DF: C8        INY ; con_plr_pos_X_hi
C - - - - - 0x00D0F0 03:D0E0: BD 6A D1  LDA tbl_D16A,X
C - - - - - 0x00D0F3 03:D0E3: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00D0F5 03:D0E5: A0 13     LDY #con_plr_direction
C - - - - - 0x00D0F7 03:D0E7: BD 6B D1  LDA tbl_D16B,X
C - - - - - 0x00D0FA 03:D0EA: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00D0FC 03:D0EC: A0 0B     LDY #con_plr_pos_Y_lo
C - - - - - 0x00D0FE 03:D0EE: AD DE 03  LDA ram_ball_pos_Y_lo
C - - - - - 0x00D101 03:D0F1: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00D103 03:D0F3: C8        INY
C - - - - - 0x00D104 03:D0F4: C8        INY ; con_plr_pos_Y_hi
C - - - - - 0x00D105 03:D0F5: AD E0 03  LDA ram_ball_pos_Y_hi
C - - - - - 0x00D108 03:D0F8: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00D10A 03:D0FA: A9 02     LDA #$02
C - - - - - 0x00D10C 03:D0FC: 20 9E C7  JSR sub_C79E
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00D117 03:D107: A9 0C     LDA #con_behavior_throw_in
C - - - - - 0x00D119 03:D109: 20 2F C6  JSR sub_C62F_player_state_handler
                                        JSR sub_C93B_set_player_flag___control
...
C - - - - - 0x00D134 03:D124: AE DA 03  LDX ram_ball_pos_X_hi
...
C - - - - - 0x00D142 03:D132: 85 67     STA ram_prg_bank_0
...
C - - - - - 0x00D159 03:D149: 8D 26 04  STA ram_ball_Z_hi
...
C - - - - - 0x00D18E 03:D17E: 8D 26 04  STA ram_ball_Z_hi
...
C - - - - - 0x00D1B0 03:D1A0: AD DA 03  LDA ram_ball_pos_X_hi
C - - - - - 0x00D1B3 03:D1A3: F0 03     BEQ bra_D1A8
C - - - - - 0x00D1B5 03:D1A5: 20 4A CB  JSR sub_CB4A
bra_D1A8:
C - - - - - 0x00D1B8 03:D1A8: 98        TYA
C - - - - - 0x00D1B9 03:D1A9: A0 07     LDY #con_plr_pos_X_hi
C - - - - - 0x00D1BB 03:D1AB: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00D1BD 03:D1AD: 88        DEY
C - - - - - 0x00D1BE 03:D1AE: 88        DEY ; con_plr_pos_X_lo
C - - - - - 0x00D1BF 03:D1AF: 8A        TXA
C - - - - - 0x00D1C0 03:D1B0: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00D1CF 03:D1BF: A0 0D     LDY #con_plr_pos_Y_hi
C - - - - - 0x00D1D1 03:D1C1: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00D1D3 03:D1C3: 88        DEY
C - - - - - 0x00D1D4 03:D1C4: 88        DEY ; con_plr_pos_Y_lo
C - - - - - 0x00D1D5 03:D1C5: 8A        TXA
C - - - - - 0x00D1D6 03:D1C6: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00D1D8 03:D1C8: A0 13     LDY #con_plr_direction
...
bra_D1D3:
C - - - - - 0x00D1E3 03:D1D3: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00D1EF 03:D1DF: 85 67     STA ram_prg_bank_0
...
C - - - - - 0x00D1FF 03:D1EF: 20 E3 CB  JSR sub_CBE3_get_base_player_address
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00D20A 03:D1FA: A9 0D     LDA #con_behavior_goal_kick
C - - - - - 0x00D20C 03:D1FC: 20 2F C6  JSR sub_C62F_player_state_handler
                                        JSR sub_C93B_set_player_flag___control
...
C - - - - - 0x00D229 03:D219: A0 06     LDY #con_plr_action_timer_1
C - - - - - 0x00D22B 03:D21B: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00D23A 03:D22A: 85 67     STA ram_prg_bank_0
...
C - - - - - 0x00D24E 03:D23E: 85 68     STA ram_prg_bank_1
...
C - - - - - 0x00D272 03:D262: 8D 26 04  STA ram_ball_Z_hi
...
C - - - - - 0x00D28A 03:D27A: AE D8 03  LDX ram_ball_pos_X_lo
C - - - - - 0x00D28D 03:D27D: AC DA 03  LDY ram_ball_pos_X_hi
...
C - - - - - 0x00D2B5 03:D2A5: AD DA 03  LDA ram_ball_pos_X_hi
C - - - - - 0x00D2B8 03:D2A8: F0 03     BEQ bra_D2AD
C - - - - - 0x00D2BA 03:D2AA: A0 CC     LDY #$CC
C - - - - - 0x00D2BC 03:D2AC: E8        INX
bra_D2AD:
C - - - - - 0x00D2BD 03:D2AD: AD E0 03  LDA ram_ball_pos_Y_hi
...
C - - - - - 0x00D2CD 03:D2BD: A0 13     LDY #con_plr_direction
C - - - - - 0x00D2CF 03:D2BF: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00D2D9 03:D2C9: 8D D8 03  STA ram_ball_pos_X_lo
C - - - - - 0x00D2DC 03:D2CC: BD 60 D3  LDA tbl_D360,X
C - - - - - 0x00D2DF 03:D2CF: 8D DA 03  STA ram_ball_pos_X_hi
C - - - - - 0x00D2E2 03:D2D2: BD 61 D3  LDA tbl_D361,X
C - - - - - 0x00D2E5 03:D2D5: 8D DE 03  STA ram_ball_pos_Y_lo
C - - - - - 0x00D2E8 03:D2D8: BD 62 D3  LDA tbl_D362,X
C - - - - - 0x00D2EB 03:D2DB: 8D E0 03  STA ram_ball_pos_Y_hi
C - - - - - 0x00D2EE 03:D2DE: A0 05     LDY #con_plr_pos_X_lo
C - - - - - 0x00D2F0 03:D2E0: BD 63 D3  LDA tbl_D363,X
C - - - - - 0x00D2F3 03:D2E3: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00D2F5 03:D2E5: C8        INY
C - - - - - 0x00D2F6 03:D2E6: C8        INY ; con_plr_pos_X_hi
C - - - - - 0x00D2F7 03:D2E7: BD 64 D3  LDA tbl_D364,X
C - - - - - 0x00D2FA 03:D2EA: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00D2FC 03:D2EC: A0 0B     LDY #con_plr_pos_Y_lo
C - - - - - 0x00D2FE 03:D2EE: BD 65 D3  LDA tbl_D365,X
C - - - - - 0x00D301 03:D2F1: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00D303 03:D2F3: C8        INY
C - - - - - 0x00D304 03:D2F4: C8        INY ; con_plr_pos_Y_hi
C - - - - - 0x00D305 03:D2F5: BD 66 D3  LDA tbl_D366,X
C - - - - - 0x00D308 03:D2F8: 91 61     STA (ram_plr_data),Y
                                        JSR sub_C943_clear_player_flag___control
...
C - - - - - 0x00D325 03:D315: 85 67     STA ram_prg_bank_0
...
C - - - - - 0x00D342 03:D332: 85 67     STA ram_prg_bank_0
...
C - - - - - 0x00D356 03:D346: 85 68     STA ram_prg_bank_1
...
C - - - - - 0x00D394 03:D384: A9 0E     LDA #con_sound_fans
...
C - - - - - 0x00D39C 03:D38C: 20 E3 CB  JSR sub_CBE3_get_base_player_address
                                        JSR sub_C945_clear_player_flag___all
C - - - - - 0x00D3A7 03:D397: A9 12     LDA #con_behavior_freeze
C - - - - - 0x00D3A9 03:D399: 20 2F C6  JSR sub_C62F_player_state_handler
...
C - - - - - 0x00D3B6 03:D3A6: AD E0 03  LDA ram_ball_pos_Y_hi
...
C - - - - - 0x00D3CF 03:D3BF: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_D3C2:
...
C - - - - - 0x00D3EF 03:D3DF: 85 67     STA ram_prg_bank_0
...
C - - - - - 0x00D43D 03:D42D: 85 67     STA ram_prg_bank_0
...
C - - - - - 0x00D477 03:D467: 85 67     STA ram_prg_bank_0
...
C - - - - - 0x00D4B4 03:D4A4: 8D 26 04  STA ram_ball_Z_hi
bra_D4A7_loop:
...
C - - - - - 0x00D4BF 03:D4AF: 20 E3 CB  JSR sub_CBE3_get_base_player_address
                                        JSR sub_C945_clear_player_flag___all
C - - - - - 0x00D4CA 03:D4BA: A9 00     LDA #con_behavior_idle
C - - - - - 0x00D4CC 03:D4BC: 20 2F C6  JSR sub_C62F_player_state_handler
bra_D4BF_it_is_gk:
...
C - - - - - 0x00D4D9 03:D4C9: 8D E4 03  STA ram_ball_anim_id
C - - - - - 0x00D4DC 03:D4CC: AD A4 03  LDA ram_game_mode_flags
C - - - - - 0x00D4DF 03:D4CF: 09 20     ORA #con_gm_out_of_play
C - - - - - 0x00D4E1 03:D4D1: 8D A4 03  STA ram_game_mode_flags
C - - - - - 0x00D4E4 03:D4D4: 60        RTS



loc_D4D5:
C D 2 - - - 0x00D4E5 03:D4D5: AD A4 03  LDA ram_game_mode_flags
...
sub_D4E8:
C - - - - - 0x00D4F8 03:D4E8: AE D8 03  LDX ram_ball_pos_X_lo
C - - - - - 0x00D4FB 03:D4EB: AC DA 03  LDY ram_ball_pos_X_hi
...
C - - - - - 0x00D510 03:D500: A9 0C     LDA #con_sound_whistle_referee
...
bra_D509:
C - - - - - 0x00D519 03:D509: AE DE 03  LDX ram_ball_pos_Y_lo
C - - - - - 0x00D51C 03:D50C: AC E0 03  LDY ram_ball_pos_Y_hi
...
C - - - - - 0x00D52A 03:D51A: AD 26 04  LDA ram_ball_Z_hi
...
bra_D558:
C - - - - - 0x00D568 03:D558: A9 0C     LDA #con_sound_whistle_referee
...
C - - - - - 0x00D588 03:D578: AC E0 03  LDY ram_ball_pos_Y_hi
...
bra_D587:
C - - - - - 0x00D597 03:D587: A9 0C     LDA #con_sound_whistle_referee
...
C - - - - - 0x00D5C7 03:D5B7: 85 67     STA ram_prg_bank_0
...
C - - - - - 0x00D5D1 03:D5C1: 20 1E 80  JSR sub_0x009852
...
bra_D5DF:
C - - - - - 0x00D5EF 03:D5DF: A0 01     LDY #con_plr_spr_A
C - - - - - 0x00D5F1 03:D5E1: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00D602 03:D5F2: 8D DE 03  STA ram_ball_pos_Y_lo
C - - - - - 0x00D605 03:D5F5: A9 00     LDA #$00
C - - - - - 0x00D607 03:D5F7: 8D D8 03  STA ram_ball_pos_X_lo
C - - - - - 0x00D60A 03:D5FA: A9 01     LDA #$01
C - - - - - 0x00D60C 03:D5FC: 8D DA 03  STA ram_ball_pos_X_hi
C - - - - - 0x00D60F 03:D5FF: A9 02     LDA #$02
C - - - - - 0x00D611 03:D601: 8D E0 03  STA ram_ball_pos_Y_hi
...
C - - - - - 0x00D63A 03:D62A: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_D62D:
...
C - - - - - 0x00D662 03:D652: EE DE 03  INC ram_ball_pos_Y_lo
C - - - - - 0x00D665 03:D655: AD DE 03  LDA ram_ball_pos_Y_lo
...
bra_D663:
C - - - - - 0x00D673 03:D663: FE 8F 00  INC ram_goals_pk,X
C - - - - - 0x00D676 03:D666: A9 0E     LDA #con_sound_fans
...
off_D680:
ofs_D680 = off_D680 - 1
C - - - - - 0x00D690 03:D680: A9 07     LDA #con_sound_catch
...
C - - - - - 0x00D6CB 03:D6BB: 8D E4 03  STA ram_ball_anim_id
...
C - - - - - 0x00D740 03:D730: AD D8 03  LDA ram_ball_pos_X_lo
C - - - - - 0x00D743 03:D733: E9 10     SBC #$10
C - - - - - 0x00D745 03:D735: AA        TAX
C - - - - - 0x00D746 03:D736: AD DA 03  LDA ram_ball_pos_X_hi
...
C - - - - - 0x00D76E 03:D75E: AD DE 03  LDA ram_ball_pos_Y_lo
C - - - - - 0x00D771 03:D761: E9 A0     SBC #$A0
C - - - - - 0x00D773 03:D763: AA        TAX
C - - - - - 0x00D774 03:D764: AD E0 03  LDA ram_ball_pos_Y_hi
...
C - - - - - 0x00D7B2 03:D7A2: 8D 26 04  STA ram_ball_Z_hi
...
C - - - - - 0x00D7F8 03:D7E8: A0 13     LDY #con_plr_direction
C - - - - - 0x00D7FA 03:D7EA: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00D812 03:D802: EE E2 03  INC ram_ball_push_anim_id
C - - - - - 0x00D815 03:D805: AD E2 03  LDA ram_ball_push_anim_id
...
bra_D814:
C - - - - - 0x00D824 03:D814: AD E2 03  LDA ram_ball_push_anim_id
C - - - - - 0x00D827 03:D817: 29 01     AND #$01
C - - - - - 0x00D829 03:D819: 8D E4 03  STA ram_ball_anim_id
C - - - - - 0x00D82C 03:D81C: EE E4 03  INC ram_ball_anim_id
C - - - - - 0x00D82F 03:D81F: A2 00     LDX #$00
C - - - - - 0x00D831 03:D821: AD E2 03  LDA ram_ball_push_anim_id
...
sub_D859:
C - - - - - 0x00D869 03:D859: A0 01     LDY #con_plr_spr_A
C - - - - - 0x00D86B 03:D85B: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00D875 03:D865: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_D868:
sub_D868:
C - - - - - 0x00D878 03:D868: 98        TYA
C - - - - - 0x00D879 03:D869: 48        PHA
C - - - - - 0x00D87A 03:D86A: 8A        TXA
C - - - - - 0x00D87B 03:D86B: A0 0B     LDY #con_plr_pos_Y_lo
C - - - - - 0x00D87D 03:D86D: 18        CLC
C - - - - - 0x00D87E 03:D86E: 71 61     ADC (ram_plr_data),Y
C - - - - - 0x00D880 03:D870: 8D DE 03  STA ram_ball_pos_Y_lo
C - - - - - 0x00D883 03:D873: C8        INY
C - - - - - 0x00D884 03:D874: C8        INY ; con_plr_pos_Y_hi
...
sub_D88A:
C - - - - - 0x00D89A 03:D88A: A0 01     LDY #con_plr_spr_A
C - - - - - 0x00D89C 03:D88C: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00D8A6 03:D896: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_D899:
sub_D899:
C - - - - - 0x00D8A9 03:D899: 98        TYA
C - - - - - 0x00D8AA 03:D89A: 48        PHA
C - - - - - 0x00D8AB 03:D89B: 8A        TXA
C - - - - - 0x00D8AC 03:D89C: A0 05     LDY #con_plr_pos_X_lo
C - - - - - 0x00D8AE 03:D89E: 18        CLC
C - - - - - 0x00D8AF 03:D89F: 71 61     ADC (ram_plr_data),Y
C - - - - - 0x00D8B1 03:D8A1: AA        TAX
C - - - - - 0x00D8B2 03:D8A2: C8        INY
C - - - - - 0x00D8B3 03:D8A3: C8        INY ; con_plr_pos_X_hi
C - - - - - 0x00D8B4 03:D8A4: 68        PLA
C - - - - - 0x00D8B5 03:D8A5: 71 61     ADC (ram_plr_data),Y
C - - - - - 0x00D8B7 03:D8A7: 10 03     BPL bra_D8AC
- - - - - - 0x00D8B9 03:D8A9: A2 00     LDX #$00
- - - - - - 0x00D8BB 03:D8AB: 8A        TXA
bra_D8AC:
C - - - - - 0x00D8BC 03:D8AC: 8E D8 03  STX ram_ball_pos_X_lo
C - - - - - 0x00D8BF 03:D8AF: 8D DA 03  STA ram_ball_pos_X_hi
C - - - - - 0x00D8C2 03:D8B2: 60        RTS



sub_D8B3:
C - - - - - 0x00D8C3 03:D8B3: AD 26 04  LDA ram_ball_Z_hi
...
C - - - - - 0x00D8E4 03:D8D4: AD E6 03  LDA ram_ball_direction
C - - - - - 0x00D8E7 03:D8D7: AE DE 03  LDX ram_ball_pos_Y_lo
C - - - - - 0x00D8EA 03:D8DA: AC E0 03  LDY ram_ball_pos_Y_hi
C - - - - - 0x00D8ED 03:D8DD: C0 02     CPY #$02
C - - - - - 0x00D8EF 03:D8DF: 90 0A     BCC bra_D8EB
C - - - - - 0x00D8F1 03:D8E1: 20 50 CB  JSR sub_CB50
C - - - - - 0x00D8F4 03:D8E4: AD E6 03  LDA ram_ball_direction
...
C - - - - - 0x00D91C 03:D90C: AE D8 03  LDX ram_ball_pos_X_lo
C - - - - - 0x00D91F 03:D90F: AC DA 03  LDY ram_ball_pos_X_hi
...
C - - - - - 0x00D93B 03:D92B: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_D92E:
...
C - - - - - 0x00D97E 03:D96E: ED E6 03  SBC ram_ball_direction
C - - - - - 0x00D981 03:D971: 0A        ASL
C - - - - - 0x00D982 03:D972: 85 2A     STA ram_002A
C - - - - - 0x00D984 03:D974: AD E6 03  LDA ram_ball_direction
...
C - - - - - 0x00D999 03:D989: A9 0D     LDA #con_sound_hit_goalspot
...
sub_D9A3:
C - - - - - 0x00D9B3 03:D9A3: AD 26 04  LDA ram_ball_Z_hi
...
C - - - - - 0x00D9C8 03:D9B8: AE DE 03  LDX ram_ball_pos_Y_lo
C - - - - - 0x00D9CB 03:D9BB: AC E0 03  LDY ram_ball_pos_Y_hi
...
C - - - - - 0x00D9E5 03:D9D5: ED 17 DA  SBC tbl_DA16 + 1
...
C - - - - - 0x00D9F0 03:D9E0: AE D8 03  LDX ram_ball_pos_X_lo
C - - - - - 0x00D9F3 03:D9E3: AC DA 03  LDY ram_ball_pos_X_hi
...
- - - - - - 0x00DA20 03:DA10: A9 0D     LDA #con_sound_hit_goalspot
...
C - - - - - 0x00DA51 03:DA41: AE DE 03  LDX ram_ball_pos_Y_lo
C - - - - - 0x00DA54 03:DA44: AC E0 03  LDY ram_ball_pos_Y_hi
...
C - - - - - 0x00DA7B 03:DA6B: B0 03     BCS bra_DA70
                                        RTS
bra_DA70:
C - - - - - 0x00DA80 03:DA70: AE D8 03  LDX ram_ball_pos_X_lo
C - - - - - 0x00DA83 03:DA73: AC DA 03  LDY ram_ball_pos_X_hi
...
C - - - - - 0x00DAC8 03:DAB8: D0 03     BNE bra_DABD
                                        RTS
bra_DABD:
C - - - - - 0x00DACD 03:DABD: AD E6 03  LDA ram_ball_direction
...
C - - - - - 0x00DAF6 03:DAE6: AD D8 03  LDA ram_ball_pos_X_lo
C - - - - - 0x00DAF9 03:DAE9: ED 56 DB  SBC tbl_DB56
C - - - - - 0x00DAFC 03:DAEC: 85 2A     STA ram_002A
C - - - - - 0x00DAFE 03:DAEE: AD DA 03  LDA ram_ball_pos_X_hi
...
C - - - - - 0x00DB1B 03:DB0B: AD E6 03  LDA ram_ball_direction
C - - - - - 0x00DB1E 03:DB0E: 49 FF     EOR #$FF
C - - - - - 0x00DB20 03:DB10: 18        CLC
C - - - - - 0x00DB21 03:DB11: 69 81     ADC #$81
loc_DB13:
C D 2 - - - 0x00DB23 03:DB13: 8D E6 03  STA ram_ball_direction
...
C - - - - - 0x00DB7E 03:DB6E: 6D DA 03  ADC ram_ball_pos_X_hi
...
C - - - - - 0x00DB9C 03:DB8C: 6D E0 03  ADC ram_ball_pos_Y_hi
...
C - - - - - 0x00DBAF 03:DB9F: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_DBA2:
...
C - - - - - 0x00DBCA 03:DBBA: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_DBBD_RTS:
...
bra_DBDD:
C - - - - - 0x00DBED 03:DBDD: 6D 26 04  ADC ram_ball_Z_hi
C - - - - - 0x00DBF0 03:DBE0: 8D 26 04  STA ram_ball_Z_hi
...
C - - - - - 0x00DC0C 03:DBFC: 8D 26 04  STA ram_ball_Z_hi
...
C - - - - - 0x00DC83 03:DC73: 6D D8 03  ADC ram_ball_pos_X_lo
...
bra_DC80:
C - - - - - 0x00DC90 03:DC80: 6D DA 03  ADC ram_ball_pos_X_hi
...
C - - - - - 0x00DC9C 03:DC8C: 8C D8 03  STY ram_ball_pos_X_lo
C - - - - - 0x00DC9F 03:DC8F: 8D DA 03  STA ram_ball_pos_X_hi
...
C - - - - - 0x00DCAD 03:DC9D: 6D DE 03  ADC ram_ball_pos_Y_lo
...
bra_DCAA:
C - - - - - 0x00DCBA 03:DCAA: 6D E0 03  ADC ram_ball_pos_Y_hi
...
C - - - - - 0x00DCC6 03:DCB6: 8C DE 03  STY ram_ball_pos_Y_lo
C - - - - - 0x00DCC9 03:DCB9: 8D E0 03  STA ram_ball_pos_Y_hi
...
C - - - - - 0x00DCD9 03:DCC9: A9 01     LDA #con_behavior_01
C - - - - - 0x00DCDB 03:DCCB: 20 2F C6  JSR sub_C62F_player_state_handler
                                        JSR sub_C93B_set_player_flag___control
C - - - - - 0x00DCE8 03:DCD8: A9 0B     LDA #$0B
C - - - - - 0x00DCEA 03:DCDA: 20 5B C9  JSR sub_C95B
C - - - - - 0x00DCED 03:DCDD: A9 01     LDA #con_behavior_01
C - - - - - 0x00DCEF 03:DCDF: 20 2F C6  JSR sub_C62F_player_state_handler
                                        JSR sub_C93B_set_player_flag___control
bra_DCEC_RTS:
...
C - - - - - 0x00DD04 03:DCF4: 8D F8 03  STA ram_shad_pos_X_lo
C - - - - - 0x00DD07 03:DCF7: AD 26 04  LDA ram_ball_Z_hi
C - - - - - 0x00DD0A 03:DCFA: 6D DA 03  ADC ram_ball_pos_X_hi
C - - - - - 0x00DD0D 03:DCFD: 8D FA 03  STA ram_shad_pos_X_hi
C - - - - - 0x00DD10 03:DD00: 18        CLC
C - - - - - 0x00DD11 03:DD01: AD DE 03  LDA ram_ball_pos_Y_lo
C - - - - - 0x00DD14 03:DD04: 69 02     ADC #$02
C - - - - - 0x00DD16 03:DD06: 8D FE 03  STA ram_shad_pos_Y_lo
C - - - - - 0x00DD19 03:DD09: AD E0 03  LDA ram_ball_pos_Y_hi
C - - - - - 0x00DD1C 03:DD0C: 69 00     ADC #$00
C - - - - - 0x00DD1E 03:DD0E: 8D 00 04  STA ram_shad_pos_Y_hi
...
C - - - - - 0x00DD30 03:DD20: AD 26 04  LDA ram_ball_Z_hi
...
C - - - - - 0x00DD41 03:DD31: 8D E4 03  STA ram_ball_anim_id
...
C - - - - - 0x00DD63 03:DD53: AD E4 03  LDA ram_ball_anim_id
C - - - - - 0x00DD66 03:DD56: 18        CLC
C - - - - - 0x00DD67 03:DD57: 69 07     ADC #$07
C - - - - - 0x00DD69 03:DD59: 8D E4 03  STA ram_ball_anim_id
bra_DD5C_RTS:
...
C - - - - - 0x00DD83 03:DD73: ED D8 03  SBC ram_ball_pos_X_lo
C - - - - - 0x00DD86 03:DD76: AA        TAX
C - - - - - 0x00DD87 03:DD77: AD 1A 04  LDA ram_ball_pass_pos_X_hi
C - - - - - 0x00DD8A 03:DD7A: ED DA 03  SBC ram_ball_pos_X_hi
C - - - - - 0x00DD8D 03:DD7D: A8        TAY
C - - - - - 0x00DD8E 03:DD7E: B0 03     BCS bra_DD83
C - - - - - 0x00DD90 03:DD80: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_DD83:
...
C - - - - - 0x00DDA1 03:DD91: ED DE 03  SBC ram_ball_pos_Y_lo
C - - - - - 0x00DDA4 03:DD94: AA        TAX
C - - - - - 0x00DDA5 03:DD95: AD 18 04  LDA ram_ball_pass_pos_Y_hi
C - - - - - 0x00DDA8 03:DD98: ED E0 03  SBC ram_ball_pos_Y_hi
C - - - - - 0x00DDAB 03:DD9B: A8        TAY
C - - - - - 0x00DDAC 03:DD9C: B0 03     BCS bra_DDA1
C - - - - - 0x00DDAE 03:DD9E: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_DDA1:
...
C - - - - - 0x00DE13 03:DE03: AD E6 03  LDA ram_ball_direction
...
C - - - - - 0x00DE31 03:DE21: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_DE24:
...
C - - - - - 0x00DE70 03:DE60: 8D 26 04  STA ram_ball_Z_hi
C - - - - - 0x00DE73 03:DE63: 60        RTS



sub_DE64:
C - - - - - 0x00DE74 03:DE64: AD E6 03  LDA ram_ball_direction
...
sub_DE6D:
C - - - - - 0x00DE7D 03:DE6D: AD E6 03  LDA ram_ball_direction
...
C - - - - - 0x00DE87 03:DE77: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_DE7A:
...
C - - - - - 0x00DEA2 03:DE92: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_DE95_RTS:
...
C - - - - - 0x00DEA8 03:DE98: 85 67     STA ram_prg_bank_0
C - - - - - 0x00DEAA 03:DE9A: A9 03     LDA #$03
C - - - - - 0x00DEAC 03:DE9C: 85 68     STA ram_prg_bank_1
...
C - - - - - 0x00DF4A 03:DF3A: A0 18     LDY #con_plr_sub_timer
C - - - - - 0x00DF4C 03:DF3C: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00DF4E 03:DF3E: F0 15     BEQ bra_DF55_check_next_player
C - - - - - 0x00DF50 03:DF40: C9 FF     CMP #$FF
C - - - - - 0x00DF52 03:DF42: F0 11     BEQ bra_DF55_check_next_player
C - - - - - 0x00DF54 03:DF44: 38        SEC
C - - - - - 0x00DF55 03:DF45: E9 01     SBC #$01
C - - - - - 0x00DF57 03:DF47: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00DF59 03:DF49: D0 0A     BNE bra_DF55_check_next_player
C - - - - - 0x00DF5B 03:DF4B: A0 16     LDY #con_plr_sub_hi
C - - - - - 0x00DF5D 03:DF4D: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00DF5F 03:DF4F: 48        PHA
C - - - - - 0x00DF60 03:DF50: C8        INY ; con_plr_sub_lo
C - - - - - 0x00DF61 03:DF51: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00DF63 03:DF53: 48        PHA
C - - - - - 0x00DF64 03:DF54: 60        RTS
bra_DF55_check_next_player:
loc_DF55_check_next_player:
...
C - - - - - 0x00DF7B 03:DF6B: A0 12     LDY #con_plr_behavior
C - - - - - 0x00DF7D 03:DF6D: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00DF7F 03:DF6F: C9 03     CMP #con_behavior_follow_ball
C - - - - - 0x00DF81 03:DF71: D0 0D     BNE bra_DF80
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00DF8B 03:DF7B: A9 00     LDA #con_behavior_idle
C - - - - - 0x00DF8D 03:DF7D: 20 2F C6  JSR sub_C62F_player_state_handler
bra_DF80:
...
C - - - - - 0x00DF9E 03:DF8E: A9 03     LDA #con_behavior_follow_ball
C - - - - - 0x00DFA0 03:DF90: 20 2F C6  JSR sub_C62F_player_state_handler
                                        JSR sub_C93B_set_player_flag___control
C - - - - - 0x00DFAD 03:DF9D: AD AD 03  LDA ram_team_w_ball
C - - - - - 0x00DFB0 03:DFA0: 49 0B     EOR #$0B
C - - - - - 0x00DFB2 03:DFA2: 20 DA C9  JSR sub_C9DA
C - - - - - 0x00DFB5 03:DFA5: A9 03     LDA #con_behavior_follow_ball
C - - - - - 0x00DFB7 03:DFA7: 20 2F C6  JSR sub_C62F_player_state_handler
                                        JSR sub_C93B_set_player_flag___control
...
sub_DFBA:
C - - - - - 0x00DFCA 03:DFBA: AD 24 00  LDA ram_btn_hold
C - - - - - 0x00DFCD 03:DFBD: AE AD 03  LDX ram_team_w_ball
C - - - - - 0x00DFD0 03:DFC0: F0 14     BEQ bra_DFD6
C - - - - - 0x00DFD2 03:DFC2: AD 25 00  LDA ram_btn_hold + 1
C - - - - - 0x00DFD5 03:DFC5: 2C A4 03  BIT ram_game_mode_flags
C - - - - - 0x00DFD8 03:DFC8: 30 0C     BMI bra_DFD6    ; con_gm_2p
...
bra_DFD6:
C - - - - - 0x00DFE6 03:DFD6: 29 0F     AND #$0F
C - - - - - 0x00DFE8 03:DFD8: F0 0B     BEQ bra_DFE5_RTS
C - - - - - 0x00DFEA 03:DFDA: AA        TAX
C - - - - - 0x00DFEB 03:DFDB: BD 83 E0  LDA tbl_E083,X
loc_DFDE:
C D 2 - - - 0x00DFEE 03:DFDE: A0 13     LDY #con_plr_direction
C - - - - - 0x00DFF0 03:DFE0: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00E00C 03:DFFC: A0 0B     LDY #con_plr_pos_Y_lo
C - - - - - 0x00E00E 03:DFFE: B1 61     LDA (ram_plr_data),Y
C D 3 - - - 0x00E010 03:E000: AA        TAX
C - - - - - 0x00E011 03:E001: C8        INY
C - - - - - 0x00E012 03:E002: C8        INY ; con_plr_pos_Y_hi
C - - - - - 0x00E013 03:E003: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00E047 03:E037: A0 1B     LDY #con_plr_aim_X_hi
C - - - - - 0x00E049 03:E039: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E04B 03:E03B: 88        DEY ; con_plr_aim_X_lo
C - - - - - 0x00E04C 03:E03C: 8A        TXA
C - - - - - 0x00E04D 03:E03D: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00E05C 03:E04C: A0 1D     LDY #con_plr_aim_Y_hi
C - - - - - 0x00E05E 03:E04E: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E060 03:E050: 88        DEY ; con_plr_aim_Y_lo
C - - - - - 0x00E061 03:E051: 8A        TXA
C - - - - - 0x00E062 03:E052: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00E084 03:E074: A0 13     LDY #con_plr_direction
C - - - - - 0x00E086 03:E076: D1 61     CMP (ram_plr_data),Y
C - - - - - 0x00E088 03:E078: F0 05     BEQ bra_E07F
C - - - - - 0x00E08A 03:E07A: 91 61     STA (ram_plr_data),Y
...
sub_E093:
C - - - - - 0x00E0A3 03:E093: AE 24 00  LDX ram_btn_hold
C - - - - - 0x00E0A6 03:E096: A8        TAY
C - - - - - 0x00E0A7 03:E097: F0 0A     BEQ bra_E0A3
C - - - - - 0x00E0A9 03:E099: AE 25 00  LDX ram_btn_hold + 1
C - - - - - 0x00E0AC 03:E09C: 2C A4 03  BIT ram_game_mode_flags
C - - - - - 0x00E0AF 03:E09F: 30 02     BMI bra_E0A3    ; con_gm_2p
...
C - - - - - 0x00E0B8 03:E0A8: 29 0F     AND #$0F
...
C - - - - - 0x00E0C8 03:E0B8: A0 05     LDY #con_plr_pos_X_lo
C - - - - - 0x00E0CA 03:E0BA: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E0CC 03:E0BC: AA        TAX
C - - - - - 0x00E0CD 03:E0BD: C8        INY
C - - - - - 0x00E0CE 03:E0BE: C8        INY ; con_plr_pos_X_hi
C - - - - - 0x00E0CF 03:E0BF: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00E0F5 03:E0E5: A0 07     LDY #con_plr_pos_X_hi
C - - - - - 0x00E0F7 03:E0E7: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E0F9 03:E0E9: 88        DEY
C - - - - - 0x00E0FA 03:E0EA: 88        DEY ; con_plr_pos_X_lo
C - - - - - 0x00E0FB 03:E0EB: 8A        TXA
C - - - - - 0x00E0FC 03:E0EC: 91 61     STA (ram_plr_data),Y
bra_E0EE:
C - - - - - 0x00E0FE 03:E0EE: A9 00     LDA #$00
C - - - - - 0x00E100 03:E0F0: 85 2A     STA ram_002A
C - - - - - 0x00E102 03:E0F2: A0 0B     LDY #con_plr_pos_Y_lo
C - - - - - 0x00E104 03:E0F4: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E106 03:E0F6: AA        TAX
C - - - - - 0x00E107 03:E0F7: C8        INY
C - - - - - 0x00E108 03:E0F8: C8        INY ; con_plr_pos_Y_hi
C - - - - - 0x00E109 03:E0F9: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00E146 03:E136: A0 0D     LDY #con_plr_pos_Y_hi
C - - - - - 0x00E148 03:E138: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E14A 03:E13A: 88        DEY
C - - - - - 0x00E14B 03:E13B: 88        DEY ; con_plr_pos_Y_lo
C - - - - - 0x00E14C 03:E13C: 8A        TXA
C - - - - - 0x00E14D 03:E13D: 91 61     STA (ram_plr_data),Y
bra_E13F:
C - - - - - 0x00E14F 03:E13F: A0 0C     LDY #con_plr_action_timer_2
C - - - - - 0x00E151 03:E141: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E153 03:E143: 38        SEC
C - - - - - 0x00E154 03:E144: E9 01     SBC #$01
C - - - - - 0x00E156 03:E146: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E158 03:E148: 10 0F     BPL bra_E159
C - - - - - 0x00E15A 03:E14A: A9 05     LDA #$05
C - - - - - 0x00E15C 03:E14C: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E15E 03:E14E: A0 0F     LDY #con_plr_anim_cnt_hi
C - - - - - 0x00E160 03:E150: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E162 03:E152: 18        CLC
C - - - - - 0x00E163 03:E153: 69 01     ADC #$01
C - - - - - 0x00E165 03:E155: 29 03     AND #$03
C - - - - - 0x00E167 03:E157: 91 61     STA (ram_plr_data),Y
bra_E159:
...
C - - - - - 0x00E17E 03:E16E: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E180 03:E170: C8        INY ; con_plr_spd_lo_init
C - - - - - 0x00E181 03:E171: A5 78     LDA ram_0078
C - - - - - 0x00E183 03:E173: 91 61     STA (ram_plr_data),Y
...
bra_E185:
                                        JSR sub_C93B_set_player_flag___control
C - - - - - 0x00E19F 03:E18F: A9 08     LDA #con_sound_tackle
...
C - - - - - 0x00E1B9 03:E1A9: A0 15     LDY #con_plr_spd_lo_init
C - - - - - 0x00E1BB 03:E1AB: A9 02     LDA #$02
C - - - - - 0x00E1BD 03:E1AD: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E1BF 03:E1AF: 88        DEY ; con_plr_spd_fr_init
C - - - - - 0x00E1C0 03:E1B0: A9 00     LDA #$00
C - - - - - 0x00E1C2 03:E1B2: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E1C4 03:E1B4: 20 80 E5  JSR sub_E580
C - - - - - 0x00E1C7 03:E1B7: A5 6F     LDA ram_006F
...
C - - - - - 0x00E1D2 03:E1C2: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E1D4 03:E1C4: A0 0C     LDY #con_plr_action_timer_2
...
C - - - - - 0x00E1E7 03:E1D7: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E1E9 03:E1D9: 38        SEC
C - - - - - 0x00E1EA 03:E1DA: E9 01     SBC #$01
C - - - - - 0x00E1EC 03:E1DC: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E1EE 03:E1DE: D0 EA     BNE bra_E1CA
C - - - - - 0x00E1F0 03:E1E0: 20 23 E2  JSR sub_E223
C - - - - - 0x00E1F3 03:E1E3: A0 06     LDY #con_plr_action_timer_1
...
C - - - - - 0x00E208 03:E1F8: 91 61     STA (ram_plr_data),Y
...
bra_E213:
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00E22B 03:E21B: A9 11     LDA #con_behavior_follow_enemy
C - - - - - 0x00E22D 03:E21D: 20 2F C6  JSR sub_C62F_player_state_handler
C - - - - - 0x00E230 03:E220: 4C 55 DF  JMP loc_DF55_check_next_player



sub_E223:
C - - - - - 0x00E233 03:E223: A0 02     LDY #con_plr_spd_X_fr_cur
C - - - - - 0x00E235 03:E225: 20 2E E2  JSR sub_E22E
C - - - - - 0x00E238 03:E228: A0 08     LDY #con_plr_spd_Y_fr_cur
...
sub_E22E:
C - - - - - 0x00E23E 03:E22E: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E240 03:E230: AA        TAX
C - - - - - 0x00E241 03:E231: C8        INY
C - - - - - 0x00E242 03:E232: C8        INY ; con_plr_spd_X_fr_cur  con_plr_spd_Y_lo_cur
C - - - - - 0x00E243 03:E233: 84 2A     STY ram_002A
C - - - - - 0x00E245 03:E235: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E247 03:E237: A8        TAY
C - - - - - 0x00E248 03:E238: 08        PHP
C - - - - - 0x00E249 03:E239: 10 03     BPL bra_E23E
C - - - - - 0x00E24B 03:E23B: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_E23E:
...
C - - - - - 0x00E257 03:E247: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_E24A:
C - - - - - 0x00E25A 03:E24A: 98        TYA
C - - - - - 0x00E25B 03:E24B: A4 2A     LDY ram_002A    ; con_plr_spd_X_fr_cur  con_plr_spd_Y_lo_cur
C - - - - - 0x00E25D 03:E24D: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E25F 03:E24F: 88        DEY
C - - - - - 0x00E260 03:E250: 88        DEY ; con_plr_spd_X_fr_cur  con_plr_spd_Y_fr_cur
C - - - - - 0x00E261 03:E251: 8A        TXA
C - - - - - 0x00E262 03:E252: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E264 03:E254: 60        RTS



sub_E255:
C - - - - - 0x00E265 03:E255: A0 0C     LDY #con_plr_action_timer_2
C - - - - - 0x00E267 03:E257: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00E289 03:E279: 20 E3 CB  JSR sub_CBE3_get_base_player_address
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00E294 03:E284: A9 06     LDA #con_behavior_dodge
C - - - - - 0x00E296 03:E286: 20 2F C6  JSR sub_C62F_player_state_handler
C - - - - - 0x00E299 03:E289: 4C 42 E3  JMP loc_E342
bra_E28C:
C - - - - - 0x00E29C 03:E28C: A0 13     LDY #con_plr_direction
C - - - - - 0x00E29E 03:E28E: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00E2A9 03:E299: A0 05     LDY #con_plr_pos_X_lo
C - - - - - 0x00E2AB 03:E29B: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E2AD 03:E29D: 85 2A     STA ram_002A
C - - - - - 0x00E2AF 03:E29F: 7D 4E E3  ADC tbl_E34E,X
C - - - - - 0x00E2B2 03:E2A2: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E2B4 03:E2A4: C8        INY
C - - - - - 0x00E2B5 03:E2A5: C8        INY ; con_plr_pos_X_hi
C - - - - - 0x00E2B6 03:E2A6: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E2B8 03:E2A8: 85 2B     STA ram_002B
C - - - - - 0x00E2BA 03:E2AA: 7D 4F E3  ADC tbl_E34F,X
C - - - - - 0x00E2BD 03:E2AD: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E2BF 03:E2AF: A0 0B     LDY #con_plr_pos_Y_lo
C - - - - - 0x00E2C1 03:E2B1: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E2C3 03:E2B3: 85 2C     STA ram_002C
C - - - - - 0x00E2C5 03:E2B5: 7D 50 E3  ADC tbl_E350,X
C - - - - - 0x00E2C8 03:E2B8: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E2CA 03:E2BA: C8        INY
C - - - - - 0x00E2CB 03:E2BB: C8        INY ; con_plr_pos_Y_hi
C - - - - - 0x00E2CC 03:E2BC: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E2CE 03:E2BE: 85 2D     STA ram_002D
C - - - - - 0x00E2D0 03:E2C0: 7D 51 E3  ADC tbl_E351,X
C - - - - - 0x00E2D3 03:E2C3: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00E2E0 03:E2D0: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E2E2 03:E2D2: C8        INY
C - - - - - 0x00E2E3 03:E2D3: C8        INY ; con_plr_pos_X_hi
C - - - - - 0x00E2E4 03:E2D4: A5 2B     LDA ram_002B
C - - - - - 0x00E2E6 03:E2D6: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E2E8 03:E2D8: A0 0B     LDY #con_plr_pos_Y_lo
C - - - - - 0x00E2EA 03:E2DA: A5 2C     LDA ram_002C
C - - - - - 0x00E2EC 03:E2DC: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E2EE 03:E2DE: C8        INY
C - - - - - 0x00E2EF 03:E2DF: C8        INY ; con_plr_pos_Y_hi
C - - - - - 0x00E2F0 03:E2E0: A5 2D     LDA ram_002D
C - - - - - 0x00E2F2 03:E2E2: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00E307 03:E2F7: A0 13     LDY #con_plr_direction
C - - - - - 0x00E309 03:E2F9: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E30B 03:E2FB: 8D E6 03  STA ram_ball_direction
...
C - - - - - 0x00E322 03:E312: A9 D6     LDA #> ofs_D6FA
C - - - - - 0x00E324 03:E314: A0 F9     LDY #< ofs_D6FA
...
C - - - - - 0x00E32E 03:E31E: 20 E3 CB  JSR sub_CBE3_get_base_player_address
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00E339 03:E329: A9 05     LDA #con_behavior_dead
C - - - - - 0x00E33B 03:E32B: 20 2F C6  JSR sub_C62F_player_state_handler
                                        JSR sub_C93B_set_player_flag___control
C - - - - - 0x00E348 03:E338: A9 80     LDA #$80
C - - - - - 0x00E34A 03:E33A: 8D 29 04  STA ram_plr_w_ball
C - - - - - 0x00E34D 03:E33D: A5 6F     LDA ram_006F
...
C - - - - - 0x00E357 03:E347: A0 0C     LDY #con_plr_action_timer_2
C - - - - - 0x00E359 03:E349: A9 80     LDA #$80
C - - - - - 0x00E35B 03:E34B: 91 61     STA (ram_plr_data),Y
bra_E34D_RTS:
...
C - - - - - 0x00E384 03:E374: A5 6F     LDA ram_006F
C - - - - - 0x00E386 03:E376: 20 B9 C6  JSR sub_C6B9
C - - - - - 0x00E389 03:E379: 20 E1 E3  JSR sub_E3E1
C - - - - - 0x00E38C 03:E37C: A9 05     LDA #con_sound_recieve
C - - - - - 0x00E38E 03:E37E: 20 10 C9  JSR sub_C910_prepare_sound
                                        JSR sub_C93B_set_player_flag___control
C - - - - - 0x00E39B 03:E38B: 20 40 C9  JSR sub_C93F_clear_player_flag___unknown
C - - - - - 0x00E39E 03:E38E: AD E6 03  LDA ram_ball_direction
C - - - - - 0x00E3A1 03:E391: 18        CLC
C - - - - - 0x00E3A2 03:E392: 69 80     ADC #$80
C - - - - - 0x00E3A4 03:E394: A0 13     LDY #con_plr_direction
C - - - - - 0x00E3A6 03:E396: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E3A8 03:E398: 38        SEC
C - - - - - 0x00E3A9 03:E399: AD 24 04  LDA ram_ball_Z_lo
C - - - - - 0x00E3AC 03:E39C: E9 0C     SBC #$0C
C - - - - - 0x00E3AE 03:E39E: AD 26 04  LDA ram_ball_Z_hi
...
C - - - - - 0x00E3BD 03:E3AD: A9 07     LDA #$07
C - - - - - 0x00E3BF 03:E3AF: 20 1E 80  JSR sub_0x00479F
...
bra_E3C7:
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00E3DF 03:E3CF: A9 02     LDA #con_behavior_w_ball
C - - - - - 0x00E3E1 03:E3D1: 20 2F C6  JSR sub_C62F_player_state_handler
                                        JSR sub_C93B_set_player_flag___control
C - - - - - 0x00E3EE 03:E3DE: 4C 55 DF  JMP loc_DF55_check_next_player



sub_E3E1:
C - - - - - 0x00E3F1 03:E3E1: AD 24 00  LDA ram_btn_hold
C - - - - - 0x00E3F4 03:E3E4: AE AD 03  LDX ram_team_w_ball
C - - - - - 0x00E3F7 03:E3E7: F0 1C     BEQ bra_E405    ; мяч у команды снизу
...
C - - - - - 0x00E404 03:E3F4: 85 67     STA ram_prg_bank_0
...
C - - - - - 0x00E422 03:E412: 20 40 C9  JSR sub_C93F_clear_player_flag___unknown
                                        JSR sub_C943_clear_player_flag___control
...
C - - - - - 0x00E435 03:E425: FD 61 E4  SBC tbl_E461_ball_Z_pos,X
C - - - - - 0x00E438 03:E428: AD 26 04  LDA ram_ball_Z_hi
C - - - - - 0x00E43B 03:E42B: FD 62 E4  SBC tbl_E461_ball_Z_pos + 1,X
C - - - - - 0x00E43E 03:E42E: 30 05     BMI bra_E435_lower_than
C - - - - - 0x00E440 03:E430: E8        INX
C - - - - - 0x00E441 03:E431: E8        INX
C - - - - - 0x00E442 03:E432: C8        INY
C - - - - - 0x00E443 03:E433: D0 EC     BNE bra_E421_loop
bra_E435_lower_than:
C - - - - - 0x00E445 03:E435: 98        TYA
C - - - - - 0x00E446 03:E436: 20 BD CA  JSR sub_CABD_bytes_after_JSR
- D 3 - I - 0x00E449 03:E439: 3F E4     .word ofs_E43F_00
- D 3 - I - 0x00E44B 03:E43B: 47 E4     .word ofs_E447_01
- D 3 - I - 0x00E44D 03:E43D: 4F E4     .word ofs_E44F_02
...
bra_E450:
                                        ...
                                        JSR sub_C93B_set_player_flag___control
C - - - - - 0x00E46E 03:E45E: 4C 55 DF  JMP loc_DF55_check_next_player



tbl_E461_ball_Z_pos:
- D 3 - - - 0x00E471 03:E461: 04 00     .word $0004
- D 3 - - - 0x00E473 03:E463: 08 00     .word $0008
- D 3 - - - 0x00E475 03:E465: FF 3F     .word $3FFF



sub_E467:
C - - - - - 0x00E477 03:E467: A0 1A     LDY #con_plr_aim_X_lo
C - - - - - 0x00E479 03:E469: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E47B 03:E46B: A0 05     LDY #con_plr_pos_X_lo
C - - - - - 0x00E47D 03:E46D: 38        SEC
C - - - - - 0x00E47E 03:E46E: F1 61     SBC (ram_plr_data),Y
C - - - - - 0x00E480 03:E470: AA        TAX
C - - - - - 0x00E481 03:E471: A0 1B     LDY #con_plr_aim_X_hi
C - - - - - 0x00E483 03:E473: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E485 03:E475: A0 07     LDY #con_plr_pos_X_hi
C - - - - - 0x00E487 03:E477: F1 61     SBC (ram_plr_data),Y
C - - - - - 0x00E489 03:E479: A8        TAY
C - - - - - 0x00E48A 03:E47A: B0 03     BCS bra_E47F
C - - - - - 0x00E48C 03:E47C: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_E47F:
...
C - - - - - 0x00E496 03:E486: A0 1C     LDY #con_plr_aim_Y_lo
C - - - - - 0x00E498 03:E488: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E49A 03:E48A: A0 0B     LDY #con_plr_pos_Y_lo
C - - - - - 0x00E49C 03:E48C: 38        SEC
C - - - - - 0x00E49D 03:E48D: F1 61     SBC (ram_plr_data),Y
C - - - - - 0x00E49F 03:E48F: AA        TAX
C - - - - - 0x00E4A0 03:E490: A0 1D     LDY #con_plr_aim_Y_hi
C - - - - - 0x00E4A2 03:E492: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E4A4 03:E494: A0 0D     LDY #con_plr_pos_Y_hi
C - - - - - 0x00E4A6 03:E496: F1 61     SBC (ram_plr_data),Y
C - - - - - 0x00E4A8 03:E498: A8        TAY
C - - - - - 0x00E4A9 03:E499: B0 03     BCS bra_E49E
C - - - - - 0x00E4AB 03:E49B: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_E49E:
...
sub_E4A9:
C - - - - - 0x00E4B9 03:E4A9: A0 02     LDY #con_plr_spd_X_fr_cur
C - - - - - 0x00E4BB 03:E4AB: 20 B0 E4  JSR sub_E4B0
C - - - - - 0x00E4BE 03:E4AE: A0 08     LDY #con_plr_spd_Y_fr_cur
sub_E4B0:
C - - - - - 0x00E4C0 03:E4B0: 18        CLC
C - - - - - 0x00E4C1 03:E4B1: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E4C3 03:E4B3: C8        INY ; con_plr_pos_X_fr  con_plr_pos_Y_fr
C - - - - - 0x00E4C4 03:E4B4: 71 61     ADC (ram_plr_data),Y
C - - - - - 0x00E4C6 03:E4B6: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E4C8 03:E4B8: A2 00     LDX #$00
C - - - - - 0x00E4CA 03:E4BA: C8        INY ; con_plr_spd_X_lo_cur  con_plr_spd_Y_lo_cur
C - - - - - 0x00E4CB 03:E4BB: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E4CD 03:E4BD: 10 01     BPL bra_E4C0
C - - - - - 0x00E4CF 03:E4BF: CA        DEX
bra_E4C0:
C - - - - - 0x00E4D0 03:E4C0: C8        INY ; con_plr_pos_X_lo  con_plr_pos_Y_lo
C - - - - - 0x00E4D1 03:E4C1: 71 61     ADC (ram_plr_data),Y
C - - - - - 0x00E4D3 03:E4C3: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E4D5 03:E4C5: C8        INY
C - - - - - 0x00E4D6 03:E4C6: C8        INY ; con_plr_pos_X_hi  con_plr_pos_Y_hi
C - - - - - 0x00E4D7 03:E4C7: 8A        TXA
C - - - - - 0x00E4D8 03:E4C8: 71 61     ADC (ram_plr_data),Y
C - - - - - 0x00E4DA 03:E4CA: 10 0A     BPL bra_E4D6
C - - - - - 0x00E4DC 03:E4CC: A9 00     LDA #$00
C - - - - - 0x00E4DE 03:E4CE: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E4E0 03:E4D0: 88        DEY
C - - - - - 0x00E4E1 03:E4D1: 88        DEY ; con_plr_pos_X_lo  con_plr_pos_Y_lo
C - - - - - 0x00E4E2 03:E4D2: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E4E4 03:E4D4: 88        DEY
C - - - - - 0x00E4E5 03:E4D5: 88        DEY ; con_plr_pos_X_fr  con_plr_pos_Y_fr
bra_E4D6:
C - - - - - 0x00E4E6 03:E4D6: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00E4FE 03:E4EE: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E500 03:E4F0: A0 00     LDY #con_plr_flags
C - - - - - 0x00E502 03:E4F2: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E504 03:E4F4: AA        TAX
C - - - - - 0x00E505 03:E4F5: 29 04     AND #con_player_flag_control
C - - - - - 0x00E507 03:E4F7: D0 0D     BNE bra_E506
C - - - - - 0x00E509 03:E4F9: 8A        TXA
C - - - - - 0x00E50A 03:E4FA: 29 08     AND #con_player_flag_busy
C - - - - - 0x00E50C 03:E4FC: F0 08     BEQ bra_E506
C - - - - - 0x00E50E 03:E4FE: 8A        TXA
C - - - - - 0x00E50F 03:E4FF: 29 F7     AND #con_player_flag_busy ^ $FF
C - - - - - 0x00E511 03:E501: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E513 03:E503: 20 12 80  JSR sub_0x0048F0
bra_E506:
C - - - - - 0x00E516 03:E506: A0 00     LDY #con_plr_flags
C - - - - - 0x00E518 03:E508: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E51A 03:E50A: 29 01     AND #con_player_flag_unknown_01
C - - - - - 0x00E51C 03:E50C: F0 09     BEQ bra_E517
C - - - - - 0x00E51E 03:E50E: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E520 03:E510: 29 FE     AND #con_player_flag_unknown_01 ^ $FF
C - - - - - 0x00E522 03:E512: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E524 03:E514: 20 27 E5  JSR sub_E527
bra_E517:
C - - - - - 0x00E527 03:E517: AE 2B 04  LDX ram_plr_frame_id
...
C - - - - - 0x00E571 03:E561: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E573 03:E563: C8        INY ; con_plr_aim_X_hi
C - - - - - 0x00E574 03:E564: AD DA 03  LDA ram_ball_pos_X_hi
C - - - - - 0x00E577 03:E567: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E579 03:E569: C8        INY ; con_plr_aim_Y_lo
C - - - - - 0x00E57A 03:E56A: AD DE 03  LDA ram_ball_pos_Y_lo
C - - - - - 0x00E57D 03:E56D: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E57F 03:E56F: C8        INY ; con_plr_aim_Y_hi
C - - - - - 0x00E580 03:E570: AD E0 03  LDA ram_ball_pos_Y_hi
C - - - - - 0x00E583 03:E573: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00E594 03:E584: A0 04     LDY #con_plr_spd_X_lo_cur
C - - - - - 0x00E596 03:E586: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E598 03:E588: 88        DEY
C - - - - - 0x00E599 03:E589: 88        DEY ; con_plr_spd_X_fr_cur
C - - - - - 0x00E59A 03:E58A: 8A        TXA
C - - - - - 0x00E59B 03:E58B: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E59D 03:E58D: 20 8D E6  JSR sub_E68D
C - - - - - 0x00E5A0 03:E590: 98        TYA
C - - - - - 0x00E5A1 03:E591: A0 0A     LDY #con_plr_spd_Y_lo_cur
C - - - - - 0x00E5A3 03:E593: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E5A5 03:E595: 88        DEY
C - - - - - 0x00E5A6 03:E596: 88        DEY ; con_plr_spd_Y_fr_cur
C - - - - - 0x00E5A7 03:E597: 8A        TXA
C - - - - - 0x00E5A8 03:E598: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00E5B4 03:E5A4: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00E5C3 03:E5B3: B1 61     LDA (ram_plr_data),Y
...
sub_E5DA:
C - - - - - 0x00E5EA 03:E5DA: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E5EC 03:E5DC: 88        DEY ; con_plr_aim_X_lo  con_plr_aim_Y_lo
C - - - - - 0x00E5ED 03:E5DD: 8A        TXA
C - - - - - 0x00E5EE 03:E5DE: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00E5F7 03:E5E7: AC 2B 04  LDY ram_plr_frame_id
...
bra_E5FD:
C - - - - - 0x00E60D 03:E5FD: AD 2B 04  LDA ram_plr_frame_id
...
C - - - - - 0x00E627 03:E617: A0 1A     LDY #con_plr_aim_X_lo
C - - - - - 0x00E629 03:E619: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E62B 03:E61B: A0 05     LDY #con_plr_pos_X_lo
C - - - - - 0x00E62D 03:E61D: 38        SEC
C - - - - - 0x00E62E 03:E61E: F1 61     SBC (ram_plr_data),Y
C - - - - - 0x00E630 03:E620: AA        TAX
C - - - - - 0x00E631 03:E621: A0 1B     LDY #con_plr_aim_X_hi
C - - - - - 0x00E633 03:E623: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E635 03:E625: A0 07     LDY #con_plr_pos_X_hi
C - - - - - 0x00E637 03:E627: F1 61     SBC (ram_plr_data),Y
C - - - - - 0x00E639 03:E629: A8        TAY
C - - - - - 0x00E63A 03:E62A: B0 03     BCS bra_E62F
C - - - - - 0x00E63C 03:E62C: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_E62F:
...
C - - - - - 0x00E649 03:E639: A0 1C     LDY #con_plr_aim_Y_lo
C - - - - - 0x00E64B 03:E63B: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E64D 03:E63D: A0 0B     LDY #con_plr_pos_Y_lo
C - - - - - 0x00E64F 03:E63F: 38        SEC
C - - - - - 0x00E650 03:E640: F1 61     SBC (ram_plr_data),Y
C - - - - - 0x00E652 03:E642: AA        TAX
C - - - - - 0x00E653 03:E643: A0 1D     LDY #con_plr_aim_Y_hi
C - - - - - 0x00E655 03:E645: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E657 03:E647: A0 0D     LDY #con_plr_pos_Y_hi
C - - - - - 0x00E659 03:E649: F1 61     SBC (ram_plr_data),Y
C - - - - - 0x00E65B 03:E64B: A8        TAY
C - - - - - 0x00E65C 03:E64C: B0 03     BCS bra_E651
C - - - - - 0x00E65E 03:E64E: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_E651:
...
bra_E688:
C - - - - - 0x00E698 03:E688: A0 13     LDY #con_plr_direction
C - - - - - 0x00E69A 03:E68A: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E69C 03:E68C: 60        RTS



sub_E68D:
C - - - - - 0x00E69D 03:E68D: A0 13     LDY #con_plr_direction
C - - - - - 0x00E69F 03:E68F: B1 61     LDA (ram_plr_data),Y
...
sub_E697:
C - - - - - 0x00E6A7 03:E697: A0 13     LDY #con_plr_direction
C - - - - - 0x00E6A9 03:E699: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00E6B2 03:E6A2: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_E6A5:
C - - - - - 0x00E6B5 03:E6A5: 86 4A     STX ram_004A
C - - - - - 0x00E6B7 03:E6A7: 84 4B     STY ram_004B
C - - - - - 0x00E6B9 03:E6A9: A0 14     LDY #con_plr_spd_fr_init
C - - - - - 0x00E6BB 03:E6AB: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E6BD 03:E6AD: 85 4C     STA ram_004C
C - - - - - 0x00E6BF 03:E6AF: C8        INY ; con_plr_spd_lo_init
C - - - - - 0x00E6C0 03:E6B0: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00E6CE 03:E6BE: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_E6C1_RTS:
C - - - - - 0x00E6D1 03:E6C1: 60        RTS



tbl_E6C2_player_state_subroutine:
- D 3 - - - 0x00E6D2 03:E6C2: F6 E6     .word ofs_E6F6_00_idle - 1
- D 3 - - - 0x00E6D4 03:E6C4: 6E E8     .word ofs_E86E_01 - 1
- D 3 - - - 0x00E6D6 03:E6C6: D8 E8     .word ofs_E8D8_02_w_ball - 1
- D 3 - - - 0x00E6D8 03:E6C8: AD EA     .word ofs_EAAD_03_follow_ball - 1
- D 3 - - - 0x00E6DA 03:E6CA: 21 EB     .word ofs_EB21_04_wo_ball - 1
- D 3 - - - 0x00E6DC 03:E6CC: 16 F0     .word ofs_F016_05_dead - 1
- D 3 - - - 0x00E6DE 03:E6CE: 67 F0     .word ofs_F067_06_dodge - 1
...
- D 3 - - - 0x00E6EA 03:E6DA: 5A F4     .word ofs_F45A_0C_throw_in - 1
- D 3 - - - 0x00E6EC 03:E6DC: 63 F5     .word ofs_F563_0D_goal_kick - 1
- D 3 - - - 0x00E6EE 03:E6DE: 85 F6     .word ofs_F685_0E_corner_kick - 1
- D 3 - - - 0x00E6F0 03:E6E0: A8 F0     .word ofs_F0A8_0F_run_area - 1
- D 3 - - - 0x00E6F2 03:E6E2: D3 F0     .word ofs_F0D3_10 - 1
- D 3 - - - 0x00E6F4 03:E6E4: FC F0     .word ofs_F0FC_11_follow_enemy - 1
- D 3 - - - 0x00E6F6 03:E6E6: E5 F1     .word ofs_F1E5_freeze - 1
...
C - - - - - 0x00E71E 03:E70E: 20 37 C9  JSR sub_C937_set_player_flag___unknown
...
C - - - - - 0x00E729 03:E719: A9 01     LDA #$01
C - - - - - 0x00E72B 03:E71B: 20 1E 80  JSR sub_0x00479F
bra_E71E:
C - - - - - 0x00E72E 03:E71E: 4C 01 E7  JMP loc_E701
bra_E721:
C - - - - - 0x00E731 03:E721: A6 6F     LDX ram_006F
...
C - - - - - 0x00E741 03:E731: A6 6F     LDX ram_006F
...
C - - - - - 0x00E75C 03:E74C: AD E6 03  LDA ram_ball_direction
C - - - - - 0x00E75F 03:E74F: A0 13     LDY #con_plr_direction
C - - - - - 0x00E761 03:E751: 38        SEC
C - - - - - 0x00E762 03:E752: F1 61     SBC (ram_plr_data),Y
...
C - - - - - 0x00E771 03:E761: 10 3C     BPL bra_E79F
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00E77B 03:E76B: A9 02     LDA #con_behavior_w_ball
C - - - - - 0x00E77D 03:E76D: 20 2F C6  JSR sub_C62F_player_state_handler
                                        JSR sub_C93B_set_player_flag___control
C - - - - - 0x00E78A 03:E77A: AD 29 04  LDA ram_plr_w_ball
C - - - - - 0x00E78D 03:E77D: 20 E3 CB  JSR sub_CBE3_get_base_player_address
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00E798 03:E788: A9 05     LDA #con_behavior_dead
C - - - - - 0x00E79A 03:E78A: 20 2F C6  JSR sub_C62F_player_state_handler
                                        JSR sub_C93B_set_player_flag___control
C - - - - - 0x00E7A7 03:E797: A5 6F     LDA ram_006F
C - - - - - 0x00E7A9 03:E799: 20 B9 C6  JSR sub_C6B9
C - - - - - 0x00E7AC 03:E79C: 4C 55 DF  JMP loc_DF55_check_next_player
bra_E79F:
C - - - - - 0x00E7AF 03:E79F: A9 05     LDA #con_behavior_dead
C - - - - - 0x00E7B1 03:E7A1: 20 2F C6  JSR sub_C62F_player_state_handler
                                        JSR sub_C93B_set_player_flag___control
C - - - - - 0x00E7BE 03:E7AE: 4C 55 DF  JMP loc_DF55_check_next_player
bra_E7B1:
...
C - - - - - 0x00E7D2 03:E7C2: AD 7F 03  LDA ram_random + 1
C - - - - - 0x00E7D5 03:E7C5: 8D E6 03  STA ram_ball_direction
...
C - - - - - 0x00E7FE 03:E7EE: A9 D6     LDA #> ofs_D6FA
...
C - - - - - 0x00E826 03:E816: 4C 55 DF  JMP loc_DF55_check_next_player
bra_E819:
...
C - - - - - 0x00E82F 03:E81F: B1 61     LDA (ram_plr_data),Y
...
bra_E838:
C - - - - - 0x00E848 03:E838: A0 14     LDY #con_plr_spd_fr_init
C - - - - - 0x00E84A 03:E83A: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E84C 03:E83C: AA        TAX
C - - - - - 0x00E84D 03:E83D: C8        INY ; con_plr_spd_lo_init
C - - - - - 0x00E84E 03:E83E: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E850 03:E840: A8        TAY
C - - - - - 0x00E851 03:E841: A9 40     LDA #$40
C - - - - - 0x00E853 03:E843: 28        PLP
C - - - - - 0x00E854 03:E844: 90 05     BCC bra_E84B
C - - - - - 0x00E856 03:E846: 20 1E C9  JSR sub_C91E_EOR_16bit
C - - - - - 0x00E859 03:E849: A9 C0     LDA #$C0
bra_E84B:
C - - - - - 0x00E85B 03:E84B: 48        PHA
C - - - - - 0x00E85C 03:E84C: 98        TYA
C - - - - - 0x00E85D 03:E84D: A0 04     LDY #con_plr_spd_X_lo_cur
C - - - - - 0x00E85F 03:E84F: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E861 03:E851: 88        DEY
C - - - - - 0x00E862 03:E852: 88        DEY ; con_plr_spd_X_fr_cur
C - - - - - 0x00E863 03:E853: 8A        TXA
C - - - - - 0x00E864 03:E854: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E866 03:E856: 68        PLA
C - - - - - 0x00E867 03:E857: A0 13     LDY #con_plr_direction
C - - - - - 0x00E869 03:E859: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00E878 03:E868: A9 02     LDA #$02
C - - - - - 0x00E87A 03:E86A: 20 1E 80  JSR sub_0x00479F
...
C - - - - - 0x00E899 03:E889: 30 10     BMI bra_E89B
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00E8A3 03:E893: A9 00     LDA #con_behavior_idle
C - - - - - 0x00E8A5 03:E895: 20 2F C6  JSR sub_C62F_player_state_handler
...
- - - - - - 0x00E8B9 03:E8A9: 20 E3 CB  JSR sub_CBE3_get_base_player_address
                                        JSR sub_C943_clear_player_flag___control
- - - - - - 0x00E8C4 03:E8B4: A9 00     LDA #con_behavior_idle
- - - - - - 0x00E8C6 03:E8B6: 20 2F C6  JSR sub_C62F_player_state_handler
bra_E8B9:
C - - - - - 0x00E8C9 03:E8B9: A5 6F     LDA ram_006F
C - - - - - 0x00E8CB 03:E8BB: 20 B9 C6  JSR sub_C6B9
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00E8D6 03:E8C6: A9 02     LDA #con_behavior_w_ball
C - - - - - 0x00E8D8 03:E8C8: 20 2F C6  JSR sub_C62F_player_state_handler
                                        JSR sub_C93B_set_player_flag___control
C - - - - - 0x00E8E5 03:E8D5: 4C 55 DF  JMP loc_DF55_check_next_player
...
C - - - - - 0x00E8F7 03:E8E7: 20 40 C9  JSR sub_C93F_clear_player_flag___unknown
...
C - - - - - 0x00E902 03:E8F2: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00E904 03:E8F4: A5 6F     LDA ram_006F
...
C - - - - - 0x00E913 03:E903: A9 D7     LDA #> ofs_D79D
C - - - - - 0x00E915 03:E905: A0 9C     LDY #< ofs_D79D
C - - - - - 0x00E917 03:E907: 20 E1 C5  JSR sub_C5E1_prepare_return_address
C - - - - - 0x00E91A 03:E90A: A5 6F     LDA ram_006F
...
C - - - - - 0x00E932 03:E922: AD 25 00  LDA ram_btn_hold + 1
C - - - - - 0x00E935 03:E925: 2C A4 03  BIT ram_game_mode_flags
C - - - - - 0x00E938 03:E928: 30 0A     BMI bra_E934    ; con_gm_2p
...
C - - - - - 0x00E969 03:E959: A9 06     LDA #$06
C - - - - - 0x00E96B 03:E95B: 20 1E 80  JSR sub_0x00479F
loc_E95E:
C D 3 - - - 0x00E96E 03:E95E: A0 13     LDY #con_plr_direction
C - - - - - 0x00E970 03:E960: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00E972 03:E962: 8D E6 03  STA ram_ball_direction
...
C - - - - - 0x00E97C 03:E96C: 2D 26 00  AND ram_btn_press
C - - - - - 0x00E97F 03:E96F: 4C 7C E9  JMP loc_E97C
bra_E972:
C - - - - - 0x00E982 03:E972: 2C A4 03  BIT ram_game_mode_flags
C - - - - - 0x00E985 03:E975: 10 9E     BPL bra_E915    ; con_gm_1p
C - - - - - 0x00E987 03:E977: A9 C0     LDA #con_btns_AB
C - - - - - 0x00E989 03:E979: 2D 27 00  AND ram_btn_press + 1
loc_E97C:
...
loc_E9BF:
C D 3 - - - 0x00E9CF 03:E9BF: A9 03     LDA #con_sound_shot
...
C - - - - - 0x00E9F2 03:E9E2: 8D E6 03  STA ram_ball_direction
...
C - - - - - 0x00EA04 03:E9F4: A9 D6     LDA #> ofs_D6FA
...
C - - - - - 0x00EA55 03:EA45: A0 13     LDY #con_plr_direction
C - - - - - 0x00EA57 03:EA47: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00EA59 03:EA49: 18        CLC
C - - - - - 0x00EA5A 03:EA4A: 69 80     ADC #$80
C - - - - - 0x00EA5C 03:EA4C: 20 1D E0  JSR sub_E01D
C - - - - - 0x00EA5F 03:EA4F: A0 1A     LDY #con_plr_aim_X_lo
C - - - - - 0x00EA61 03:EA51: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00EA63 03:EA53: 8D 19 04  STA ram_ball_pass_pos_X_lo
C - - - - - 0x00EA66 03:EA56: C8        INY ; con_plr_aim_X_hi
C - - - - - 0x00EA67 03:EA57: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00EA69 03:EA59: 8D 1A 04  STA ram_ball_pass_pos_X_hi
C - - - - - 0x00EA6C 03:EA5C: A0 1C     LDY #con_plr_aim_Y_lo   ; bzk опт INY, хотя по идее не желательно
C - - - - - 0x00EA6E 03:EA5E: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00EA70 03:EA60: 8D 17 04  STA ram_ball_pass_pos_Y_lo
C - - - - - 0x00EA73 03:EA63: C8        INY ; con_plr_aim_Y_hi
C - - - - - 0x00EA74 03:EA64: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00EA90 03:EA80: A0 05     LDY #con_plr_pos_X_lo
C - - - - - 0x00EA92 03:EA82: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00EA94 03:EA84: 8D 19 04  STA ram_ball_pass_pos_X_lo
C - - - - - 0x00EA97 03:EA87: C8        INY
C - - - - - 0x00EA98 03:EA88: C8        INY ; con_plr_pos_X_hi
C - - - - - 0x00EA99 03:EA89: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00EA9B 03:EA8B: 8D 1A 04  STA ram_ball_pass_pos_X_hi
C - - - - - 0x00EA9E 03:EA8E: A0 0B     LDY #con_plr_pos_Y_lo
C - - - - - 0x00EAA0 03:EA90: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00EAA2 03:EA92: 8D 17 04  STA ram_ball_pass_pos_Y_lo
C - - - - - 0x00EAA5 03:EA95: C8        INY
C - - - - - 0x00EAA6 03:EA96: C8        INY ; con_plr_pos_Y_hi
C - - - - - 0x00EAA7 03:EA97: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00EAB5 03:EAA5: 8D E6 03  STA ram_ball_direction
C - - - - - 0x00EAB8 03:EAA8: A0 13     LDY #con_plr_direction
C - - - - - 0x00EABA 03:EAAA: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00EABC 03:EAAC: 60        RTS



ofs_EAAD_03_follow_ball:
                                        JSR sub_C93B_set_player_flag___control
bra_EAB7:
loc_EAB7:
...
C - - - - - 0x00EAD7 03:EAC7: D1 61     CMP (ram_plr_data),Y
C - - - - - 0x00EAD9 03:EAC9: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00EAE1 03:EAD1: 10 F1     BPL bra_EAC4_loop
...
bra_EAEE:
C - - - - - 0x00EAFE 03:EAEE: AD E6 03  LDA ram_ball_direction
C - - - - - 0x00EB01 03:EAF1: 18        CLC
C - - - - - 0x00EB02 03:EAF2: 69 80     ADC #$80
C - - - - - 0x00EB04 03:EAF4: A0 13     LDY #con_plr_direction
C - - - - - 0x00EB06 03:EAF6: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00EB08 03:EAF8: 20 77 C6  JSR sub_C677
C - - - - - 0x00EB0B 03:EAFB: A9 01     LDA #$01
C - - - - - 0x00EB0D 03:EAFD: 20 1E 80  JSR sub_0x00479F
loc_EB00:
C D 3 - - - 0x00EB10 03:EB00: 2C 29 04  BIT ram_plr_w_ball
C - - - - - 0x00EB13 03:EB03: 30 10     BMI bra_EB15
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00EB1D 03:EB0D: A9 00     LDA #con_behavior_idle
C - - - - - 0x00EB1F 03:EB0F: 20 2F C6  JSR sub_C62F_player_state_handler
...
C - - - - - 0x00EB57 03:EB47: AD A4 03  LDA ram_game_mode_flags
C - - - - - 0x00EB5A 03:EB4A: 29 20     AND #con_gm_out_of_play
...
bra_EB5E:
C - - - - - 0x00EB6E 03:EB5E: A5 6F     LDA ram_006F
C - - - - - 0x00EB70 03:EB60: C9 0B     CMP #$0B
C - - - - - 0x00EB72 03:EB62: 90 15     BCC bra_EB79
C - - - - - 0x00EB74 03:EB64: 2C A4 03  BIT ram_game_mode_flags
C - - - - - 0x00EB77 03:EB67: 30 10     BMI bra_EB79    ; con_gm_2p
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00EB81 03:EB71: A9 11     LDA #con_behavior_follow_enemy
C - - - - - 0x00EB83 03:EB73: 20 2F C6  JSR sub_C62F_player_state_handler
...
C - - - - - 0x00EB93 03:EB83: F0 10     BEQ bra_EB95
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00EB9D 03:EB8D: A9 00     LDA #con_behavior_idle
C - - - - - 0x00EB9F 03:EB8F: 20 2F C6  JSR sub_C62F_player_state_handler
C - - - - - 0x00EBA2 03:EB92: 4C 55 DF  JMP loc_DF55_check_next_player
bra_EB95:
C - - - - - 0x00EBA5 03:EB95: AD 24 00  LDA ram_btn_hold
C - - - - - 0x00EBA8 03:EB98: AE AD 03  LDX ram_team_w_ball
C - - - - - 0x00EBAB 03:EB9B: D0 03     BNE bra_EBA0
C - - - - - 0x00EBAD 03:EB9D: AD 25 00  LDA ram_btn_hold + 1
bra_EBA0:
...
C - - - - - 0x00EBC3 03:EBB3: A9 01     LDA #$01
C - - - - - 0x00EBC5 03:EBB5: 20 1E 80  JSR sub_0x00479F
loc_EBB8:
...
C - - - - - 0x00EBD6 03:EBC6: 20 E3 CB  JSR sub_CBE3_get_base_player_address
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00EBE1 03:EBD1: A9 05     LDA #con_behavior_dead
C - - - - - 0x00EBE3 03:EBD3: 20 2F C6  JSR sub_C62F_player_state_handler
                                        JSR sub_C93B_set_player_flag___control
bra_EBE0:
C - - - - - 0x00EBF0 03:EBE0: A5 6F     LDA ram_006F
C - - - - - 0x00EBF2 03:EBE2: 20 B9 C6  JSR sub_C6B9
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00EBFD 03:EBED: A9 02     LDA #con_behavior_w_ball
C - - - - - 0x00EBFF 03:EBEF: 20 2F C6  JSR sub_C62F_player_state_handler
                                        JSR sub_C93B_set_player_flag___control
C - - - - - 0x00EC0C 03:EBFC: 4C 55 DF  JMP loc_DF55_check_next_player
bra_EBFF:
...
C - - - - - 0x00EC16 03:EC06: 2D 26 00  AND ram_btn_press
C - - - - - 0x00EC19 03:EC09: 4C 11 EC  JMP loc_EC11
bra_EC0C:
C - - - - - 0x00EC1C 03:EC0C: A9 80     LDA #con_btn_A
C - - - - - 0x00EC1E 03:EC0E: 2D 27 00  AND ram_btn_press + 1
loc_EC11:
...
sub_EC19:
C - - - - - 0x00EC29 03:EC19: A0 0B     LDY #con_plr_pos_Y_lo
C - - - - - 0x00EC2B 03:EC1B: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00EC2D 03:EC1D: AA        TAX
C - - - - - 0x00EC2E 03:EC1E: C8        INY
C - - - - - 0x00EC2F 03:EC1F: C8        INY ; con_plr_pos_Y_hi
C - - - - - 0x00EC30 03:EC20: B1 61     LDA (ram_plr_data),Y
...
- - - - - - 0x00EC50 03:EC40: A0 0D     LDY #con_plr_pos_Y_hi
- - - - - - 0x00EC52 03:EC42: 91 61     STA (ram_plr_data),Y
- - - - - - 0x00EC54 03:EC44: 88        DEY
- - - - - - 0x00EC55 03:EC45: 88        DEY ; con_plr_pos_Y_lo
- - - - - - 0x00EC56 03:EC46: 8A        TXA
- - - - - - 0x00EC57 03:EC47: 91 61     STA (ram_plr_data),Y
bra_EC49:
...
loc_EC4B:
C D 3 - - - 0x00EC5B 03:EC4B: A0 0C     LDY #con_plr_action_timer_2
C - - - - - 0x00EC5D 03:EC4D: A9 00     LDA #$00
C - - - - - 0x00EC5F 03:EC4F: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00EC61 03:EC51: A5 6F     LDA ram_006F
...
bra_EC71:
C - - - - - 0x00EC81 03:EC71: E4 6F     CPX ram_006F
C - - - - - 0x00EC83 03:EC73: D0 15     BNE bra_EC8A
bra_EC75:
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00EC8D 03:EC7D: A9 00     LDA #con_behavior_idle
C - - - - - 0x00EC8F 03:EC7F: 20 2F C6  JSR sub_C62F_player_state_handler
C - - - - - 0x00EC92 03:EC82: A9 80     LDA #$80
C - - - - - 0x00EC94 03:EC84: 8D 2A 04  STA ram_plr_wo_ball
C - - - - - 0x00EC97 03:EC87: 4C 55 DF  JMP loc_DF55_check_next_player
bra_EC8A:
C - - - - - 0x00EC9A 03:EC8A: A5 6F     LDA ram_006F
C - - - - - 0x00EC9C 03:EC8C: F0 1D     BEQ bra_ECAB
C - - - - - 0x00EC9E 03:EC8E: 2C A4 03  BIT ram_game_mode_flags
C - - - - - 0x00ECA1 03:EC91: 30 18     BMI bra_ECAB    ; con_gm_2p
C - - - - - 0x00ECA3 03:EC93: 48        PHA
C - - - - - 0x00ECA4 03:EC94: A9 02     LDA #$02
C - - - - - 0x00ECA6 03:EC96: 85 67     STA ram_prg_bank_0
...
C - - - - - 0x00ECDE 03:ECCE: AD 26 04  LDA ram_ball_Z_hi
...
bra_ECE9:
C - - - - - 0x00ECF9 03:ECE9: AD 26 04  LDA ram_ball_Z_hi
...
C - - - - - 0x00ED13 03:ED03: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00ED15 03:ED05: 18        CLC
C - - - - - 0x00ED16 03:ED06: 69 80     ADC #$80
C - - - - - 0x00ED18 03:ED08: 38        SEC
C - - - - - 0x00ED19 03:ED09: ED E6 03  SBC ram_ball_direction
...
C - - - - - 0x00ED2B 03:ED1B: 8D E4 03  STA ram_ball_anim_id
C - - - - - 0x00ED2E 03:ED1E: A9 00     LDA #$00
C - - - - - 0x00ED30 03:ED20: 8D 24 04  STA ram_ball_Z_lo
C - - - - - 0x00ED33 03:ED23: 8D 26 04  STA ram_ball_Z_hi
                                        JSR sub_C93B_set_player_flag___control
C - - - - - 0x00ED40 03:ED30: 20 40 C9  JSR sub_C93F_clear_player_flag___unknown
C - - - - - 0x00ED43 03:ED33: 20 77 C6  JSR sub_C677
C - - - - - 0x00ED46 03:ED36: A5 6F     LDA ram_006F
C - - - - - 0x00ED48 03:ED38: 20 2B C9  JSR sub_C92B
C - - - - - 0x00ED4B 03:ED3B: AD E6 03  LDA ram_ball_direction
...
C - - - - - 0x00ED5B 03:ED4B: A0 13     LDY #con_plr_direction
C - - - - - 0x00ED5D 03:ED4D: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00ED72 03:ED62: A0 06     LDY #con_plr_action_timer_1
C - - - - - 0x00ED74 03:ED64: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00ED7F 03:ED6F: A0 01     LDY #con_plr_spr_A
C - - - - - 0x00ED81 03:ED71: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00ED83 03:ED73: 29 3F     AND #$3F
C - - - - - 0x00ED85 03:ED75: 05 2A     ORA ram_002A
C - - - - - 0x00ED87 03:ED77: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00ED92 03:ED82: A0 0F     LDY #con_plr_anim_cnt_hi
C - - - - - 0x00ED94 03:ED84: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00ED96 03:ED86: 20 A3 EE  JSR sub_EEA3
C - - - - - 0x00ED99 03:ED89: A9 00     LDA #$00
C - - - - - 0x00ED9B 03:ED8B: A0 0C     LDY #con_plr_action_timer_2
C - - - - - 0x00ED9D 03:ED8D: 91 61     STA (ram_plr_data),Y
loc_ED8F:
C D 3 - - - 0x00ED9F 03:ED8F: A0 0C     LDY #con_plr_action_timer_2
C - - - - - 0x00EDA1 03:ED91: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00EDA3 03:ED93: AA        TAX
C - - - - - 0x00EDA4 03:ED94: 18        CLC
C - - - - - 0x00EDA5 03:ED95: 69 01     ADC #$01
C - - - - - 0x00EDA7 03:ED97: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00EDA9 03:ED99: BD BF EF  LDA tbl_EFBF,X
C - - - - - 0x00EDAC 03:ED9C: D0 0B     BNE bra_EDA9
C - - - - - 0x00EDAE 03:ED9E: 2C 98 00  BIT ram_0098
...
C - - - - - 0x00EDBD 03:EDAD: 2C 98 00  BIT ram_0098
C - - - - - 0x00EDC0 03:EDB0: 10 02     BPL bra_EDB4
C - - - - - 0x00EDC2 03:EDB2: A9 0C     LDA #$0C
bra_EDB4:
C - - - - - 0x00EDC4 03:EDB4: 48        PHA
C - - - - - 0x00EDC5 03:EDB5: A0 06     LDY #con_plr_action_timer_1
C - - - - - 0x00EDC7 03:EDB7: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00EDE1 03:EDD1: A0 0F     LDY #con_plr_anim_cnt_hi
C - - - - - 0x00EDE3 03:EDD3: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00EDE5 03:EDD5: AA        TAX
C - - - - - 0x00EDE6 03:EDD6: 18        CLC
C - - - - - 0x00EDE7 03:EDD7: 69 01     ADC #$01
C - - - - - 0x00EDE9 03:EDD9: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00EE37 03:EE27: 6D E6 03  ADC ram_ball_direction
C - - - - - 0x00EE3A 03:EE2A: 8D E6 03  STA ram_ball_direction
...
C - - - - - 0x00EE52 03:EE42: A9 1C     LDA #con_sound_syndrom
...
C - - - - - 0x00EE5F 03:EE4F: 20 E3 CB  JSR sub_CBE3_get_base_player_address
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00EE6A 03:EE5A: A9 00     LDA #con_behavior_idle
C - - - - - 0x00EE6C 03:EE5C: 20 2F C6  JSR sub_C62F_player_state_handler
bra_EE5F:
C - - - - - 0x00EE6F 03:EE5F: A5 6F     LDA ram_006F
C - - - - - 0x00EE71 03:EE61: 20 B9 C6  JSR sub_C6B9
C - - - - - 0x00EE74 03:EE64: A9 07     LDA #con_sound_catch
...
bra_EE7D:
C - - - - - 0x00EE8D 03:EE7D: A0 0C     LDY #con_plr_action_timer_2
...
C - - - - - 0x00EEC3 03:EEB3: A9 1C     LDA #con_sound_syndrom
...
C - - - - - 0x00EED5 03:EEC5: A6 6F     LDX ram_006F
...
C - - - - - 0x00EEDE 03:EECE: 8D E6 03  STA ram_ball_direction
...
C - - - - - 0x00EEF1 03:EEE1: 20 E3 CB  JSR sub_CBE3_get_base_player_address
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00EEFC 03:EEEC: A9 00     LDA #con_behavior_idle
C - - - - - 0x00EEFE 03:EEEE: 20 2F C6  JSR sub_C62F_player_state_handler
C - - - - - 0x00EF01 03:EEF1: A5 6F     LDA ram_006F
...
loc_EEFD:
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00EF15 03:EF05: A9 16     LDA #con_behavior_gk_get_ball
C - - - - - 0x00EF17 03:EF07: 20 2F C6  JSR sub_C62F_player_state_handler
                                        JSR sub_C93B_set_player_flag___control
...
C - - - - - 0x00EF2E 03:EF1E: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00EF49 03:EF39: A0 01     LDY #con_plr_spr_A
C - - - - - 0x00EF4B 03:EF3B: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00EF5C 03:EF4C: A0 05     LDY #con_plr_pos_X_lo
C - - - - - 0x00EF5E 03:EF4E: 18        CLC
C - - - - - 0x00EF5F 03:EF4F: 71 61     ADC (ram_plr_data),Y
C - - - - - 0x00EF61 03:EF51: 8D D8 03  STA ram_ball_pos_X_lo
C - - - - - 0x00EF64 03:EF54: C8        INY
C - - - - - 0x00EF65 03:EF55: C8        INY ; con_plr_pos_X_hi
...
C - - - - - 0x00EF6D 03:EF5D: 71 61     ADC (ram_plr_data),Y
C - - - - - 0x00EF6F 03:EF5F: 8D DA 03  STA ram_ball_pos_X_hi
C - - - - - 0x00EF72 03:EF62: A0 01     LDY #con_plr_spr_A
C - - - - - 0x00EF74 03:EF64: B1 61     LDA (ram_plr_data),Y
...
C - - - - - 0x00EF85 03:EF75: A0 0B     LDY #con_plr_pos_Y_lo
C - - - - - 0x00EF87 03:EF77: 18        CLC
C - - - - - 0x00EF88 03:EF78: 71 61     ADC (ram_plr_data),Y
C - - - - - 0x00EF8A 03:EF7A: 8D DE 03  STA ram_ball_pos_Y_lo
C - - - - - 0x00EF8D 03:EF7D: C8        INY
C - - - - - 0x00EF8E 03:EF7E: C8        INY ; con_plr_pos_Y_hi
...
C - - - - - 0x00EF96 03:EF86: 71 61     ADC (ram_plr_data),Y
...
ofs_F016_05_dead:
C - - - - - 0x00F026 03:F016: A9 02     LDA #con_sound_dead
C - - - - - 0x00F028 03:F018: 20 10 C9  JSR sub_C910_prepare_sound
                                        JSR sub_C93B_set_player_flag___control
C - - - - - 0x00F035 03:F025: 20 40 C9  JSR sub_C93F_clear_player_flag___unknown
...
C - - - - - 0x00F05F 03:F04F: A5 6F     LDA ram_006F
C - - - - - 0x00F061 03:F051: 48        PHA
C - - - - - 0x00F062 03:F052: A9 02     LDA #$02
C - - - - - 0x00F064 03:F054: 85 67     STA ram_prg_bank_0
...
C - - - - - 0x00F071 03:F061: 20 48 80  JSR sub_0x0048C2
...
ofs_F067_06_dodge:
                                        JSR sub_C93B_set_player_flag___control
C - - - - - 0x00F081 03:F071: 20 40 C9  JSR sub_C93F_clear_player_flag___unknown
...
C - - - - - 0x00F0A8 03:F098: 20 2F C6  JSR sub_C62F_player_state_handler
                                        JSR sub_C93B_set_player_flag___control
C - - - - - 0x00F0B5 03:F0A5: 4C 55 DF  JMP loc_DF55_check_next_player



ofs_F0A8_0F_run_area:
ofs_F0A8_15_run_base:
                                        JSR sub_C943_clear_player_flag___control
loc_F0B0:
...
C - - - - - 0x00F0CE 03:F0BE: D1 61     CMP (ram_plr_data),Y
C - - - - - 0x00F0D0 03:F0C0: D0 08     BNE bra_F0CA
C - - - - - 0x00F0D2 03:F0C2: A9 00     LDA #con_behavior_idle
C - - - - - 0x00F0D4 03:F0C4: 20 2F C6  JSR sub_C62F_player_state_handler
...
C - - - - - 0x00F0FB 03:F0EB: A9 01     LDA #$01
C - - - - - 0x00F0FD 03:F0ED: 20 1E 80  JSR sub_0x00479F
...
ofs_F0FC_11_follow_enemy:
C - - - - - 0x00F10C 03:F0FC: 20 77 C6  JSR sub_C677
loc_F0FF:
C D 3 - - - 0x00F10F 03:F0FF: AD A4 03  LDA ram_game_mode_flags
...
C - - - - - 0x00F130 03:F120: A0 06     LDY #con_plr_action_timer_1
...
C - - - - - 0x00F14F 03:F13F: D0 10     BNE bra_F151
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00F159 03:F149: A9 00     LDA #con_behavior_idle
C - - - - - 0x00F15B 03:F14B: 20 2F C6  JSR sub_C62F_player_state_handler
...
C - - - - - 0x00F166 03:F156: A0 06     LDY #con_plr_action_timer_1
C - - - - - 0x00F168 03:F158: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00F16A 03:F15A: 18        CLC
C - - - - - 0x00F16B 03:F15B: 69 01     ADC #$01
C - - - - - 0x00F16D 03:F15D: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00F182 03:F172: 20 40 C9  JSR sub_C93F_clear_player_flag___unknown
...
C - - - - - 0x00F19D 03:F18D: 20 E3 CB  JSR sub_CBE3_get_base_player_address
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00F1A8 03:F198: A9 05     LDA #con_behavior_dead
C - - - - - 0x00F1AA 03:F19A: 20 2F C6  JSR sub_C62F_player_state_handler
                                        JSR sub_C93B_set_player_flag___control
...
C - - - - - 0x00F1BE 03:F1AE: 20 B9 C6  JSR sub_C6B9
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00F1C9 03:F1B9: A9 02     LDA #con_behavior_w_ball
C - - - - - 0x00F1CB 03:F1BB: 20 2F C6  JSR sub_C62F_player_state_handler
                                        JSR sub_C93B_set_player_flag___control
C - - - - - 0x00F1D8 03:F1C8: 4C 55 DF  JMP loc_DF55_check_next_player
bra_F1CB:
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00F1E3 03:F1D3: A9 05     LDA #con_behavior_dead
C - - - - - 0x00F1E5 03:F1D5: 20 2F C6  JSR sub_C62F_player_state_handler
                                        JSR sub_C93B_set_player_flag___control
C - - - - - 0x00F1F2 03:F1E2: 4C 55 DF  JMP loc_DF55_check_next_player
...
C - - - - - 0x00F20F 03:F1FF: 20 37 C9  JSR sub_C937_set_player_flag___unknown
...
C - - - - - 0x00F21C 03:F20C: A9 01     LDA #$01
bra_F20E:
C - - - - - 0x00F21E 03:F20E: 20 1E 80  JSR sub_0x00479F
...
C - - - - - 0x00F230 03:F220: 8D E4 03  STA ram_ball_anim_id
C - - - - - 0x00F233 03:F223: 20 37 C9  JSR sub_C937_set_player_flag___unknown
...
C - - - - - 0x00F240 03:F230: A0 06     LDY #con_plr_action_timer_1
...
C - - - - - 0x00F256 03:F246: 2C A4 03  BIT ram_game_mode_flags
C - - - - - 0x00F259 03:F249: 30 0D     BMI bra_F258    ; con_gm_2p
C - - - - - 0x00F25B 03:F24B: A0 06     LDY #con_plr_action_timer_1
C - - - - - 0x00F25D 03:F24D: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00F25F 03:F24F: 38        SEC
C - - - - - 0x00F260 03:F250: E9 01     SBC #$01
C - - - - - 0x00F262 03:F252: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00F264 03:F254: F0 09     BEQ bra_F25F
C - - - - - 0x00F266 03:F256: D0 DC     BNE bra_F234_loop
bra_F258:
C - - - - - 0x00F268 03:F258: A9 C0     LDA #con_btns_AB
C - - - - - 0x00F26A 03:F25A: 3D 26 00  AND ram_btn_press,X
C - - - - - 0x00F26D 03:F25D: F0 D5     BEQ bra_F234_loop
bra_F25F:
C - - - - - 0x00F26F 03:F25F: A9 0C     LDA #con_sound_whistle_referee
C - - - - - 0x00F271 03:F261: 20 10 C9  JSR sub_C910_prepare_sound
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00F27C 03:F26C: A9 02     LDA #con_behavior_w_ball
C - - - - - 0x00F27E 03:F26E: 20 2F C6  JSR sub_C62F_player_state_handler
                                        JSR sub_C93B_set_player_flag___control
C - - - - - 0x00F28B 03:F27B: AD 2A 04  LDA ram_plr_wo_ball
C - - - - - 0x00F28E 03:F27E: 20 E3 CB  JSR sub_CBE3_get_base_player_address
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00F299 03:F289: A9 04     LDA #con_behavior_wo_ball
C - - - - - 0x00F29B 03:F28B: 20 2F C6  JSR sub_C62F_player_state_handler
...
C - - - - - 0x00F2AC 03:F29C: 29 DF     AND #con_gm_out_of_play ^ $FF
C - - - - - 0x00F2AE 03:F29E: 8D A4 03  STA ram_game_mode_flags
C - - - - - 0x00F2B1 03:F2A1: 4C 55 DF  JMP loc_DF55_check_next_player
...
C - - - - - 0x00F2C2 03:F2B2: D1 61     CMP (ram_plr_data),Y
C - - - - - 0x00F2C4 03:F2B4: D0 10     BNE bra_F2C6
                                        JSR sub_C943_clear_player_flag___control
C - - - - - 0x00F2CE 03:F2BE: A9 00     LDA #con_behavior_idle
C - - - - - 0x00F2D0 03:F2C0: 20 2F C6  JSR sub_C62F_player_state_handler
...
C - - - - - 0x00F2EF 03:F2DF: A9 03     LDA #con_sound_shot
...
C - - - - - 0x00F336 03:F326: A9 03     LDA #con_sound_shot
...
C - - - - - 0x00F39A 03:F38A: A9 04     LDA #con_sound_fast_shot
C - - - - - 0x00F39C 03:F38C: 20 10 C9  JSR sub_C910_prepare_sound
C - - - - - 0x00F39F 03:F38F: A0 13     LDY #con_plr_direction
C - - - - - 0x00F3A1 03:F391: AD E6 03  LDA ram_ball_direction
C - - - - - 0x00F3A4 03:F394: 38        SEC
C - - - - - 0x00F3A5 03:F395: F1 61     SBC (ram_plr_data),Y
...
sub_F428:
C - - - - - 0x00F438 03:F428: A0 13     LDY #con_plr_direction
C - - - - - 0x00F43A 03:F42A: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00F43C 03:F42C: 8D E6 03  STA ram_ball_direction
...
C - - - - - 0x00F462 03:F452: A9 D6     LDA #> ofs_D6FA
C - - - - - 0x00F464 03:F454: A0 F9     LDY #< ofs_D6FA
...
; !!!
ofs_F45A_0C_throw_in:
                                        JSR sub_C93B_set_player_flag___control
C - - - - - 0x00F474 03:F464: 20 77 C6  JSR sub_C677
C - - - - - 0x00F477 03:F467: A5 6F     LDA ram_006F
...
C - - - - - 0x00F481 03:F471: 2C A4 03  BIT ram_game_mode_flags
C - - - - - 0x00F484 03:F474: 30 10     BMI bra_F486    ; con_gm_2p
C - - - - - 0x00F486 03:F476: 48        PHA
C - - - - - 0x00F487 03:F477: A9 02     LDA #$02
C - - - - - 0x00F489 03:F479: 85 67     STA ram_prg_bank_0
C - - - - - 0x00F48B 03:F47B: A9 03     LDA #$03
C - - - - - 0x00F48D 03:F47D: 85 68     STA ram_prg_bank_1
C - - - - - 0x00F48F 03:F47F: 20 58 CB  JSR sub_CB58_prg_bankswitch
C - - - - - 0x00F492 03:F482: 68        PLA
C - - - - - 0x00F493 03:F483: 20 3C 80  JSR sub_0x004BEC_bot_throw_in_timer
bra_F486:
loc_F486_loop:
...
C - - - - - 0x00F4A2 03:F492: 20 1E 80  JSR sub_0x00479F
C - - - - - 0x00F4A5 03:F495: AD 24 00  LDA ram_btn_hold
C - - - - - 0x00F4A8 03:F498: AE AD 03  LDX ram_team_w_ball
C - - - - - 0x00F4AB 03:F49B: F0 0C     BEQ bra_F4A9
C - - - - - 0x00F4AD 03:F49D: A9 00     LDA #$00
C - - - - - 0x00F4AF 03:F49F: 2C A4 03  BIT ram_game_mode_flags
C - - - - - 0x00F4B2 03:F4A2: 10 05     BPL bra_F4A9    ; con_gm_1p
C - - - - - 0x00F4B4 03:F4A4: AD 25 00  LDA ram_btn_hold + 1
C - - - - - 0x00F4B7 03:F4A7: A2 01     LDX #$01
bra_F4A9:
C - - - - - 0x00F4B9 03:F4A9: 86 2B     STX ram_002B
C - - - - - 0x00F4BB 03:F4AB: 29 0F     AND #con_btns_Dpad
C - - - - - 0x00F4BD 03:F4AD: 85 2A     STA ram_002A
C - - - - - 0x00F4BF 03:F4AF: F0 2C     BEQ bra_F4DD
C - - - - - 0x00F4C1 03:F4B1: A2 01     LDX #$01
C - - - - - 0x00F4C3 03:F4B3: A0 07     LDY #con_plr_pos_X_hi
C - - - - - 0x00F4C5 03:F4B5: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00F4C7 03:F4B7: F0 01     BEQ bra_F4BA
C - - - - - 0x00F4C9 03:F4B9: E8        INX
bra_F4BA:
C - - - - - 0x00F4CA 03:F4BA: 8A        TXA
C - - - - - 0x00F4CB 03:F4BB: 2D 2A 00  AND ram_002A
C - - - - - 0x00F4CE 03:F4BE: D0 11     BNE bra_F4D1
C - - - - - 0x00F4D0 03:F4C0: A5 2A     LDA ram_002A
C - - - - - 0x00F4D2 03:F4C2: 29 0C     AND #$0C
C - - - - - 0x00F4D4 03:F4C4: F0 17     BEQ bra_F4DD
C - - - - - 0x00F4D6 03:F4C6: A5 2A     LDA ram_002A
C - - - - - 0x00F4D8 03:F4C8: 29 FC     AND #$FC
C - - - - - 0x00F4DA 03:F4CA: 85 2A     STA ram_002A
C - - - - - 0x00F4DC 03:F4CC: 8A        TXA
C - - - - - 0x00F4DD 03:F4CD: 05 2A     ORA ram_002A
C - - - - - 0x00F4DF 03:F4CF: 85 2A     STA ram_002A
bra_F4D1:
C - - - - - 0x00F4E1 03:F4D1: A5 2A     LDA ram_002A
C - - - - - 0x00F4E3 03:F4D3: 29 0F     AND #$0F
C - - - - - 0x00F4E5 03:F4D5: AA        TAX
C - - - - - 0x00F4E6 03:F4D6: BD 83 E0  LDA tbl_E083,X
C - - - - - 0x00F4E9 03:F4D9: A0 13     LDY #con_plr_direction
C - - - - - 0x00F4EB 03:F4DB: 91 61     STA (ram_plr_data),Y
bra_F4DD:
C - - - - - 0x00F4ED 03:F4DD: A9 C0     LDA #con_btns_AB
C - - - - - 0x00F4EF 03:F4DF: A6 2B     LDX ram_002B
C - - - - - 0x00F4F1 03:F4E1: F0 13     BEQ bra_F4F6
C - - - - - 0x00F4F3 03:F4E3: 2C A4 03  BIT ram_game_mode_flags
C - - - - - 0x00F4F6 03:F4E6: 30 0E     BMI bra_F4F6    ; con_gm_2p
C - - - - - 0x00F4F8 03:F4E8: A0 0C     LDY #con_plr_action_timer_2
C - - - - - 0x00F4FA 03:F4EA: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00F4FC 03:F4EC: 38        SEC
C - - - - - 0x00F4FD 03:F4ED: E9 01     SBC #$01
C - - - - - 0x00F4FF 03:F4EF: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00F501 03:F4F1: F0 08     BEQ bra_F4FB_throw_ball
C - - - - - 0x00F503 03:F4F3: 4C 86 F4  JMP loc_F486_loop
bra_F4F6:
C - - - - - 0x00F506 03:F4F6: 3D 26 00  AND ram_btn_press,X
C - - - - - 0x00F509 03:F4F9: F0 8B     BEQ bra_F486
bra_F4FB_throw_ball:
C - - - - - 0x00F50B 03:F4FB: 20 6D C6  JSR sub_C66D
C - - - - - 0x00F50E 03:F4FE: A9 0F     LDA #$0F
C - - - - - 0x00F510 03:F500: 20 1E 80  JSR sub_0x00479F
C - - - - - 0x00F513 03:F503: A9 03     LDA #$03
C - - - - - 0x00F515 03:F505: 20 9E C7  JSR sub_C79E
C - - - - - 0x00F518 03:F508: A9 06     LDA #con_sound_throw
...
C - - - - - 0x00F527 03:F517: A0 13     LDY #con_plr_direction
C - - - - - 0x00F529 03:F519: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00F52B 03:F51B: 8D E6 03  STA ram_ball_direction
...
C - - - - - 0x00F542 03:F532: A9 D6     LDA #> ofs_D6FA
C - - - - - 0x00F544 03:F534: A0 F9     LDY #< ofs_D6FA
...
ofs_F563_0D_goal_kick:
ofs_F563_16_gk_get_ball:
                                        JSR sub_C93B_set_player_flag___control
C - - - - - 0x00F57D 03:F56D: 20 77 C6  JSR sub_C677
C - - - - - 0x00F580 03:F570: A0 0C     LDY #con_plr_action_timer_2
C - - - - - 0x00F582 03:F572: A9 00     LDA #$00
C - - - - - 0x00F584 03:F574: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00F58F 03:F57F: 8D E4 03  STA ram_ball_anim_id
C - - - - - 0x00F592 03:F582: A5 6F     LDA ram_006F
C - - - - - 0x00F594 03:F584: 20 2B C9  JSR sub_C92B
C - - - - - 0x00F597 03:F587: A5 6F     LDA ram_006F
...
C - - - - - 0x00F5C3 03:F5B3: A9 12     LDA #$12
C - - - - - 0x00F5C5 03:F5B5: 20 1E 80  JSR sub_0x00479F
C - - - - - 0x00F5C8 03:F5B8: 4C C0 F5  JMP loc_F5C0
bra_F5BB:
loc_F5BB:
C D 3 - - - 0x00F5CB 03:F5BB: A9 10     LDA #$10
C - - - - - 0x00F5CD 03:F5BD: 20 1E 80  JSR sub_0x00479F
loc_F5C0:
...
C - - - - - 0x00F5DF 03:F5CF: 2C A4 03  BIT ram_game_mode_flags
C - - - - - 0x00F5E2 03:F5D2: 30 0D     BMI bra_F5E1    ; con_gm_2p
C - - - - - 0x00F5E4 03:F5D4: A0 06     LDY #con_plr_action_timer_1
C - - - - - 0x00F5E6 03:F5D6: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00F5E8 03:F5D8: 38        SEC
C - - - - - 0x00F5E9 03:F5D9: E9 01     SBC #$01
C - - - - - 0x00F5EB 03:F5DB: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00F5ED 03:F5DD: D0 B0     BNE bra_F58F
C - - - - - 0x00F5EF 03:F5DF: F0 14     BEQ bra_F5F5
bra_F5E1:
C - - - - - 0x00F5F1 03:F5E1: A9 C0     LDA #con_btns_AB
C - - - - - 0x00F5F3 03:F5E3: 3D 26 00  AND ram_btn_press,X
...
C - - - - - 0x00F613 03:F603: A9 11     LDA #$11
C - - - - - 0x00F615 03:F605: 20 1E 80  JSR sub_0x00479F
...
C - - - - - 0x00F63E 03:F62E: A0 13     LDY #con_plr_direction
C - - - - - 0x00F640 03:F630: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00F642 03:F632: 8D E6 03  STA ram_ball_direction
...
C - - - - - 0x00F64F 03:F63F: A9 D6     LDA #> ofs_D6FA
C - - - - - 0x00F651 03:F641: A0 F9     LDY #< ofs_D6FA
...
ofs_F685_0E_corner_kick:
                                        JSR sub_C93B_set_player_flag___control
C - - - - - 0x00F69F 03:F68F: 20 77 C6  JSR sub_C677
C - - - - - 0x00F6A2 03:F692: A5 6F     LDA ram_006F
...
C - - - - - 0x00F6AC 03:F69C: 2C A4 03  BIT ram_game_mode_flags
C - - - - - 0x00F6AF 03:F69F: 30 0C     BMI bra_F6AD    ; con_gm_2p
C - - - - - 0x00F6B1 03:F6A1: A0 06     LDY #con_plr_action_timer_1
...
C - - - - - 0x00F6BB 03:F6AB: 91 61     STA (ram_plr_data),Y
bra_F6AD:
loc_F6AD:
...
C - - - - - 0x00F71E 03:F70E: 2C A4 03  BIT ram_game_mode_flags
C - - - - - 0x00F721 03:F711: 30 0D     BMI bra_F720    ; con_gm_2p
loc_F713:
C D 3 - - - 0x00F723 03:F713: A0 06     LDY #con_plr_action_timer_1
C - - - - - 0x00F725 03:F715: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00F727 03:F717: 38        SEC
C - - - - - 0x00F728 03:F718: E9 01     SBC #$01
C - - - - - 0x00F72A 03:F71A: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00F72C 03:F71C: D0 8F     BNE bra_F6AD
C - - - - - 0x00F72E 03:F71E: F0 0A     BEQ bra_F72A
bra_F720:
C - - - - - 0x00F730 03:F720: A9 C0     LDA #con_btns_AB
C - - - - - 0x00F732 03:F722: 3D 26 00  AND ram_btn_press,X
...
C - - - - - 0x00F765 03:F755: A0 13     LDY #con_plr_direction
C - - - - - 0x00F767 03:F757: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00F769 03:F759: 8D E6 03  STA ram_ball_direction
...
C - - - - - 0x00F77B 03:F76B: A9 D6     LDA #> ofs_D6FA
C - - - - - 0x00F77D 03:F76D: A0 F9     LDY #< ofs_D6FA
...
bra_F7B4:
C - - - - - 0x00F7C4 03:F7B4: A0 13     LDY #con_plr_direction
C - - - - - 0x00F7C6 03:F7B6: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00F7FB 03:F7EB: 20 58 CB  JSR sub_CB58_prg_bankswitch
                                        LDX #$00
C - - - - - 0x00F7FF 03:F7EF: 20 42 80  JSR sub_0x004B34_random_button
C - - - - - 0x00F802 03:F7F2: 4C FF F7  JMP loc_F7FF_check_buttons
bra_F7F5:
...
C - - - - - 0x00F87E 03:F86E: 20 58 CB  JSR sub_CB58_prg_bankswitch
                                        LDX #$02
C - - - - - 0x00F882 03:F872: 20 42 80  JSR sub_0x004B34_random_button
C - - - - - 0x00F885 03:F875: 4C 88 F8  JMP loc_F888_check_buttons
bra_F878:
C - - - - - 0x00F888 03:F878: A9 0B     LDA #con_btns_LR + con_btn_Up
C - - - - - 0x00F88A 03:F87A: 3D 26 00  AND ram_btn_press,X
C - - - - - 0x00F88D 03:F87D: D0 06     BNE bra_F885
C - - - - - 0x00F88F 03:F87F: 20 49 F9  JSR sub_F949
C - - - - - 0x00F892 03:F882: 4C 46 F8  JMP loc_F846
bra_F885:
C - - - - - 0x00F895 03:F885: BD 24 00  LDA ram_btn_hold,X
loc_F888_check_buttons:
...
C - - - - - 0x00F8B2 03:F8A2: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_F8A5:
C - - - - - 0x00F8B5 03:F8A5: 98        TYA
C - - - - - 0x00F8B6 03:F8A6: A0 04     LDY #con_plr_spd_X_lo_cur
C - - - - - 0x00F8B8 03:F8A8: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00F8BA 03:F8AA: 88        DEY
C - - - - - 0x00F8BB 03:F8AB: 88        DEY ; con_plr_spd_X_fr_cur
C - - - - - 0x00F8BC 03:F8AC: 8A        TXA
C - - - - - 0x00F8BD 03:F8AD: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00F8E5 03:F8D5: 91 61     STA (ram_plr_data),Y
C - - - - - 0x00F8E7 03:F8D7: C8        INY
C - - - - - 0x00F8E8 03:F8D8: C8        INY ; con_plr_spd_Y_lo_cur
C - - - - - 0x00F8E9 03:F8D9: BD 31 F9  LDA tbl_F931,X
C - - - - - 0x00F8EC 03:F8DC: 91 61     STA (ram_plr_data),Y
...
C - - - - - 0x00F904 03:F8F4: D0 D1     BNE bra_F8C7_loop
...
C - - - - - 0x00F91F 03:F90F: A0 0B     LDY #con_plr_pos_Y_lo
C - - - - - 0x00F921 03:F911: A9 87     LDA #$87
C - - - - - 0x00F923 03:F913: 91 61     STA (ram_plr_data),Y
bra_F915:
...
C - - - - - 0x00F971 03:F961: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00F973 03:F963: C9 80     CMP #$80
C - - - - - 0x00F975 03:F965: D0 06     BNE bra_F96D
C - - - - - 0x00F977 03:F967: A9 F0     LDA #$F0
C - - - - - 0x00F979 03:F969: A0 11     LDY #con_plr_anim_id
C - - - - - 0x00F97B 03:F96B: 91 61     STA (ram_plr_data),Y
bra_F96D:
...
C - - - - - 0x00F987 03:F977: A9 D6     LDA #> ofs_D680
C - - - - - 0x00F989 03:F979: A0 7F     LDY #< ofs_D680
...
C - - - - - 0x00F9F5 03:F9E5: BD 75 FB  LDA tbl_FB74_sprite_text_messages + 1,X
...
C - - - - - 0x00FA57 03:FA47: AC 26 04  LDY ram_ball_Z_hi
...
C - - - - - 0x00FA7F 03:FA6F: A0 05     LDY #con_plr_pos_X_lo
C - - - - - 0x00FA81 03:FA71: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00FA83 03:FA73: F1 70     SBC (ram_0070),Y
C - - - - - 0x00FA85 03:FA75: AA        TAX
C - - - - - 0x00FA86 03:FA76: C8        INY
C - - - - - 0x00FA87 03:FA77: C8        INY ; con_plr_pos_X_hi
C - - - - - 0x00FA88 03:FA78: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00FA8A 03:FA7A: F1 70     SBC (ram_0070),Y
C - - - - - 0x00FA8C 03:FA7C: A8        TAY
C - - - - - 0x00FA8D 03:FA7D: 10 03     BPL bra_FA82
C - - - - - 0x00FA8F 03:FA7F: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_FA82:
...
C - - - - - 0x00FA9A 03:FA8A: A0 0B     LDY #con_plr_pos_Y_lo
C - - - - - 0x00FA9C 03:FA8C: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00FA9E 03:FA8E: F1 70     SBC (ram_0070),Y
C - - - - - 0x00FAA0 03:FA90: AA        TAX
C - - - - - 0x00FAA1 03:FA91: C8        INY
C - - - - - 0x00FAA2 03:FA92: C8        INY ; con_plr_pos_Y_hi
C - - - - - 0x00FAA3 03:FA93: B1 61     LDA (ram_plr_data),Y
C - - - - - 0x00FAA5 03:FA95: F1 70     SBC (ram_0070),Y
C - - - - - 0x00FAA7 03:FA97: A8        TAY
C - - - - - 0x00FAA8 03:FA98: 10 03     BPL bra_FA9D
C - - - - - 0x00FAAA 03:FA9A: 20 1E C9  JSR sub_C91E_EOR_16bit
bra_FA9D:
